...
module.exports.Agenda = function Agenda (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14 2V0H1v17h13v-2h2V2h-2zM2 16V1h2v15H2zm11 0H5V1h8v15zm2-2h-1v-3h1v3zm0-4h-1V7h1v3zm-1-4V3h1v3h-1zM6 4h5v1H6V4zm0 2h4v1H6V6z"/></svg>
};
module.exports.AlarmClock = function AlarmClock (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14.714 6.791a2.69 2.69 0 0 0 .786-1.903 2.729 2.729 0 0 0-2.725-2.726c-.886 0-1.695.434-2.207 1.15A6.938 6.938 0 0 0 9 3.025V2h1V1H7v1h1v1.025a6.938 6.938 0 0 0-1.568.287 2.703 2.703 0 0 0-2.207-1.15A2.729 2.729 0 0 0 1.5 4.888c0 .723.282 1.392.786 1.903a6.963 6.963 0 0 0 .849 7.696L1.85 16.2l.8.6 1.192-1.59C5.081 16.319 6.71 17 8.5 17s3.419-.681 4.658-1.79l1.192 1.59.8-.6-1.285-1.713a6.963 6.963 0 0 0 .849-7.696zm-1.939-3.629c.951 0 1.725.774 1.725 1.726 0 .373-.12.724-.335 1.017a7.031 7.031 0 0 0-2.63-2.202 1.705 1.705 0 0 1 1.24-.541zM2.5 4.888c0-.951.774-1.726 1.725-1.726.478 0 .918.202 1.24.54a7.048 7.048 0 0 0-2.63 2.202A1.707 1.707 0 0 1 2.5 4.888zM8.5 16c-3.309 0-6-2.691-6-6s2.691-6 6-6 6 2.691 6 6-2.691 6-6 6zm.5-6h4v1H8V7h1v3z"/></svg>
};
module.exports.Alert = function Alert (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.454 1.492.212 16h16.581L8.454 1.492zm.005 2.016L15.064 15H1.93L8.459 3.508zM9 10.938H8V7h1v3.938zm.5 2.093a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/></svg>
};
module.exports.AlignCenter = function AlignCenter (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 2v1H0V2h17zM1.5 6v1h14V6h-14zM0 11h17v-1H0v1zm3.5 4h10v-1h-10v1z"/></svg>
};
module.exports.AlignJustify = function AlignJustify (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 2v1H0V2h17zM0 7h17V6H0v1zm0 4h17v-1H0v1zm0 4h17v-1H0v1z"/></svg>
};
module.exports.AlignLeft = function AlignLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 2v1H0V2h17zm-3 4H0v1h14V6zM0 11h17v-1H0v1zm0 4h10v-1H0v1z"/></svg>
};
module.exports.AlignRight = function AlignRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 2v1H0V2h17zM3 7h14V6H3v1zm-3 4h17v-1H0v1zm7 4h10v-1H7v1z"/></svg>
};
module.exports.Anchor = function Anchor (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m15.291 12.592-1.57-3.127-3.127 1.568.448.895 1.871-.939A4.491 4.491 0 0 1 9 14.574V7h1.5V6H9V4.949c1.14-.232 2-1.241 2-2.449C11 1.121 9.878 0 8.5 0S6 1.121 6 2.5c0 1.208.86 2.217 2 2.449V6H6.5v1H8v7.574a4.491 4.491 0 0 1-3.912-3.58l1.86.934.448-.895-3.127-1.568-1.57 3.127.894.449.651-1.298A5.51 5.51 0 0 0 8.5 15.625a5.51 5.51 0 0 0 5.252-3.867l.645 1.283.894-.449zM7 2.5C7 1.673 7.673 1 8.5 1s1.5.673 1.5 1.5S9.327 4 8.5 4 7 3.327 7 2.5z"/></svg>
};
module.exports.Android = function Android (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M3.809 5.696h9.383v6.807a1.12 1.12 0 0 1-1.113 1.125h-.769v2.32a1.053 1.053 0 0 1-2.106 0v-2.32H7.796v2.32c0 .582-.472 1.052-1.055 1.052a1.05 1.05 0 0 1-1.042-1.052l-.009-2.32h-.757a1.122 1.122 0 0 1-1.124-1.125V5.696zm-1.452-.194a1.05 1.05 0 0 0-1.053 1.042v4.396c0 .583.471 1.052 1.053 1.052s1.042-.47 1.042-1.052V6.544c0-.571-.468-1.042-1.042-1.042zm10.865-.174H3.768c0-1.625.972-3.036 2.413-3.771L5.454.219a.149.149 0 0 1 .051-.205c.071-.031.164-.011.205.062l.735 1.349c.625-.277 1.32-.43 2.055-.43s1.43.153 2.055.429L11.29.075c.041-.072.134-.092.205-.062a.149.149 0 0 1 .051.205l-.727 1.338c1.432.736 2.403 2.147 2.403 3.772zM6.741 3.223a.398.398 0 0 0-.397-.399.397.397 0 0 0-.389.399c0 .214.173.398.389.398a.397.397 0 0 0 .397-.398zm4.304 0a.397.397 0 0 0-.389-.399.398.398 0 0 0 0 .797.395.395 0 0 0 .389-.398zm3.598 2.279a1.04 1.04 0 0 0-1.042 1.042v4.396a1.047 1.047 0 1 0 2.095 0V6.544a1.044 1.044 0 0 0-1.053-1.042z"/></svg>
};
module.exports.AngleDoubleDown = function AngleDoubleDown (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5 10.644 1.646 3.79l.707-.707L8.5 9.229l6.146-6.146.707.707L8.5 10.644zm0 3.43L2.354 7.927l-.708.707L8.5 15.488l6.854-6.854-.707-.707L8.5 14.074z"/></svg>
};
module.exports.AngleDoubleLeft = function AngleDoubleLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m7.987 8.5 6.146 6.146-.707.707L6.573 8.5l6.854-6.854.707.707L7.987 8.5zM9.29 2.353l-.707-.707L1.729 8.5l6.854 6.854.707-.707L3.144 8.5 9.29 2.353z"/></svg>
};
module.exports.AngleDoubleRight = function AngleDoubleRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M9.644 8.5 2.79 15.354l-.707-.707L8.229 8.5 2.083 2.354l.707-.708L9.644 8.5zm-2.01-6.854-.707.708L13.073 8.5l-6.146 6.146.707.707L14.487 8.5 7.634 1.646z"/></svg>
};
module.exports.AngleDoubleUp = function AngleDoubleUp (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m8.5 6.073 6.854 6.854-.707.707L8.5 7.487l-6.146 6.146-.707-.707L8.5 6.073zm0-3.429 6.146 6.146.707-.707L8.5 1.229 1.646 8.083l.708.707L8.5 2.644z"/></svg>
};
module.exports.AngleDown = function AngleDown (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m16.354 5.075-7.855 7.854L.646 5.075l.707-.707 7.145 7.146 7.148-7.147.708.708z"/></svg>
};
module.exports.AngleLeft = function AngleLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m5.207 8.471 7.146 7.147-.707.707-7.853-7.854L11.647.618l.707.707-7.147 7.146z"/></svg>
};
module.exports.AngleRight = function AngleRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m13.207 8.472-7.854 7.854-.707-.707 7.146-7.146-7.146-7.148.707-.707 7.854 7.854z"/></svg>
};
module.exports.AngleUp = function AngleUp (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m16.354 11.896-.707.707L8.5 5.457l-7.146 7.146-.707-.707L8.5 4.043l7.854 7.853z"/></svg>
};
module.exports.Announcement = function Announcement (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.469 2.222h-1.927a.527.527 0 0 0-.531.521v.667L3.016 7.44v-.27a.79.79 0 0 0-.797-.781H.797A.79.79 0 0 0 0 7.17v4.688c0 .429.358.781.797.781h1.422a.792.792 0 0 0 .797-.781v-.331l1.034.189a3.506 3.506 0 0 0-.038.491c0 1.897 1.561 3.441 3.479 3.441a3.438 3.438 0 0 0 3.38-2.682l3.14.576v.659c0 .287.239.521.531.521h1.927a.527.527 0 0 0 .531-.521V2.743a.527.527 0 0 0-.531-.521zM7.491 14.648c-1.367 0-2.479-1.095-2.479-2.441 0-.104.027-.205.04-.308l4.84.888a2.449 2.449 0 0 1-2.401 1.861zM16 13.722h-.989v-1.013L2.016 10.326v1.312H1v-4.25h1.016v1.484l12.995-4.763v-.887H16v10.5z"/></svg>
};
module.exports.Apple = function Apple (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14.001 11.125a3.91 3.91 0 0 1-.704-2.278c0-.776.225-1.482.664-2.115.245-.357.633-.756 1.165-1.205-.347-.43-.706-.777-1.063-1.022a3.73 3.73 0 0 0-2.176-.664c-.501 0-1.093.123-1.767.347-.675.235-1.165.348-1.461.348-.236 0-.706-.102-1.411-.307-.715-.204-1.308-.306-1.808-.306-1.176 0-2.136.491-2.901 1.471-.766.991-1.154 2.258-1.154 3.821 0 1.675.511 3.381 1.501 5.139C3.897 16.111 4.909 17 5.961 17c.337 0 .787-.112 1.349-.348.553-.224 1.042-.337 1.451-.337.419 0 .939.102 1.542.327.614.214 1.083.327 1.431.327.868 0 1.747-.665 2.626-2.003.592-.889 1.001-1.747 1.256-2.554-.602-.183-1.144-.612-1.615-1.287zm-.478 3.293c-.657 1-1.293 1.552-1.79 1.552-.147 0-.459-.047-1.081-.264-.693-.259-1.33-.39-1.892-.39-.541 0-1.155.138-1.838.415-.58.243-.865.269-.961.269-.628 0-1.412-.762-2.204-2.137-.923-1.639-1.372-3.159-1.372-4.648 0-1.336.31-2.387.942-3.206.579-.741 1.251-1.086 2.113-1.086.401 0 .902.088 1.529.267 1.051.305 1.444.346 1.689.346.425 0 1.01-.132 1.777-.399.589-.196 1.077-.296 1.45-.296a2.727 2.727 0 0 1 1.814.644 5.282 5.282 0 0 0-.562.677 4.622 4.622 0 0 0-.843 2.686c0 1.048.297 2.006.884 2.85.354.505.748.908 1.182 1.206a9.752 9.752 0 0 1-.837 1.514zM9.424 3.964c-.235.072-.582.133-1.062.174.021-1.011.286-1.89.797-2.625C9.67.776 10.527.276 11.714 0c.02.092.04.164.05.225 0 .071.011.132.011.204 0 .419-.102.889-.296 1.39a4.175 4.175 0 0 1-.951 1.41c-.368.367-.736.612-1.104.735z"/></svg>
};
module.exports.Archive = function Archive (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 2H0v4h1v11h15V6h1V2zm-2 14H2V6h13v10zm1-11H1V3h15v2zM6 11h5.016c1.103 0 2-.897 2-2s-.897-2-2-2H6c-1.103 0-2 .897-2 2s.897 2 2 2zm0-3h5.016a1 1 0 0 1 0 2H6a1 1 0 0 1 0-2z"/></svg>
};
module.exports.ArrowCircleDown = function ArrowCircleDown (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m12.146 6.146.707.707L8.5 11.207 4.146 6.854l.707-.707L8.5 9.793l3.646-3.647zM17 8.5c0 4.687-3.813 8.5-8.5 8.5S0 13.187 0 8.5 3.813 0 8.5 0 17 3.813 17 8.5zm-1 0C16 4.364 12.636 1 8.5 1S1 4.364 1 8.5 4.364 16 8.5 16 16 12.636 16 8.5z"/></svg>
};
module.exports.ArrowCircleLeft = function ArrowCircleLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M10.854 4.854 7.207 8.5l3.646 3.646-.707.707L5.793 8.5l4.354-4.354.707.708zM17 8.5c0 4.687-3.813 8.5-8.5 8.5S0 13.187 0 8.5 3.813 0 8.5 0 17 3.813 17 8.5zm-1 0C16 4.364 12.636 1 8.5 1S1 4.364 1 8.5 4.364 16 8.5 16 16 12.636 16 8.5z"/></svg>
};
module.exports.ArrowCircleRight = function ArrowCircleRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M6.854 4.146 11.207 8.5l-4.354 4.354-.707-.707L9.793 8.5 6.146 4.854l.708-.708zM17 8.5c0 4.687-3.813 8.5-8.5 8.5S0 13.187 0 8.5 3.813 0 8.5 0 17 3.813 17 8.5zm-1 0C16 4.364 12.636 1 8.5 1S1 4.364 1 8.5 4.364 16 8.5 16 16 12.636 16 8.5z"/></svg>
};
module.exports.ArrowCircleUp = function ArrowCircleUp (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m8.5 5.793 4.354 4.354-.707.707L8.5 7.207l-3.646 3.646-.707-.707L8.5 5.793zM17 8.5c0 4.687-3.813 8.5-8.5 8.5S0 13.187 0 8.5 3.813 0 8.5 0 17 3.813 17 8.5zm-1 0C16 4.364 12.636 1 8.5 1S1 4.364 1 8.5 4.364 16 8.5 16 16 12.636 16 8.5z"/></svg>
};
module.exports.ArrowDown = function ArrowDown (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.854 8.854 8.5 16.207 1.146 8.854l.707-.707L8 14.293V1h1v13.293l6.146-6.146.708.707z"/></svg>
};
module.exports.ArrowLeft = function ArrowLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16 8.972H3.207l6.146 6.146-.707.707-7.353-7.353 7.354-7.354.707.707-6.147 6.147H16v1z"/></svg>
};
module.exports.ArrowRight = function ArrowRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m15.707 8.472-7.354 7.354-.707-.707 6.146-6.146H1v-1h12.793L7.646 1.825l.707-.707 7.354 7.354z"/></svg>
};
module.exports.ArrowTopLeft = function ArrowTopLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12.292 13 1.975 2.703V10h-1V.997H10v1H2.684l10.315 10.295-.707.708z"/></svg>
};
module.exports.ArrowTopRight = function ArrowTopRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16 .997V10h-1V2.703L4.683 13l-.707-.708L14.291 1.997H6.975v-1H16z"/></svg>
};
module.exports.ArrowUp = function ArrowUp (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.146 8.854 9 2.707V16H8V2.707L1.854 8.854l-.708-.708L8.5.793l7.354 7.354-.708.707z"/></svg>
};
module.exports.Arrow = function Arrow (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m13.603 11.349-.706-.708L14.541 9H9v5.541l1.641-1.644.708.706L8.5 16.458l-2.849-2.855.708-.706L8 14.541V9H2.459l1.644 1.641-.706.708L.542 8.5l2.855-2.849.706.708L2.459 8H8V2.459L6.359 4.103l-.708-.706L8.5.542l2.849 2.855-.708.706L9 2.459V8h5.541l-1.644-1.641.706-.708L16.458 8.5l-2.855 2.849z"/></svg>
};
module.exports.ArrowsCorner = function ArrowsCorner (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 9.5V15H9.5v-1h3.803L3 3.697V7.5H2V2h5.5v1H3.717L14 13.283V9.5h1z"/></svg>
};
module.exports.ArrowsHorizontal = function ArrowsHorizontal (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m16.716 8.5-3.954 3.858-.698-.716L14.771 9H2.229l2.708 2.642-.698.716L.284 8.5l3.954-3.858.698.716L2.229 8h12.543l-2.708-2.642.698-.716L16.716 8.5z"/></svg>
};
module.exports.ArrowsVertical = function ArrowsVertical (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m11.642 12.063.716.698L8.5 16.716l-3.858-3.954.716-.698L8 14.771V2.229L5.358 4.937l-.716-.699L8.5.284l3.858 3.954-.716.698L9 2.229v12.543l2.642-2.709z"/></svg>
};
module.exports.BackLeft = function BackLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 7.5c0 3.033-2.467 5.5-5.5 5.5H6.588l2.646 2.646-.707.707L4.674 12.5l3.854-3.854.707.707L6.588 12H9.5c2.481 0 4.5-2.019 4.5-4.5S11.981 3 9.5 3H2.417V2H9.5C12.533 2 15 4.467 15 7.5z"/></svg>
};
module.exports.BackRight = function BackRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14.583 15v1H7.5C4.468 16 2 13.533 2 10.5S4.468 5 7.5 5h2.912L7.766 2.354l.707-.707L12.326 5.5 8.473 9.354l-.707-.708L10.412 6H7.5C5.019 6 3 8.019 3 10.5S5.019 15 7.5 15h7.083z"/></svg>
};
module.exports.Bag = function Bag (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M13 4V1.606C13 .721 12.263 0 11.357 0H5.658c-.905 0-1.642.721-1.642 1.606V4H1v13h15V4h-3zM5.016 1.606c0-.334.288-.606.642-.606h5.699c.355 0 .643.272.643.606V4H5.016V1.606zM15 16H2V8h13v8zm0-9H2V5h2.016v.643h1V5H12v.643h1V5h2v2z"/></svg>
};
module.exports.BarChartAlt = function BarChartAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 16v1H0v-1h17zm-5-6h2v5h1V9h-4v6h1v-5zM7 7h2v8h1V6H6v9h1V7zM2 3h2v12h1V2H1v13h1V3z"/></svg>
};
module.exports.BarChart = function BarChart (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 16v1H0v-1h17zM2 10h2v5h1V9H1v6h1v-5zm5-3h2v8h1V6H6v9h1V7zm5-4h2v12h1V2h-4v13h1V3z"/></svg>
};
...
module.exports.Bell = function Bell (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.312 14.125c-.014-.013-1.312-1.294-1.312-3.21V7.623C14 4.522 11.532 2 8.5 2S3 4.522 3 7.623v3.292c0 1.861-1.306 3.203-1.318 3.216l-.843.853h15.357l-.884-.859zm-12.26-.141c.444-.692.948-1.764.948-3.069V7.623C4 5.074 6.019 3 8.5 3S13 5.074 13 7.623v3.292c0 1.32.495 2.383.938 3.069H3.052zM9 2H8V1h1v1zm0 13h1c0 .827-.673 1.5-1.5 1.5S7 15.827 7 15h1a.5.5 0 0 0 1 0z"/></svg>
};
module.exports.Blackboard = function Blackboard (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M9 2V0H8v2H1v10h15V2H9zm6 9H2V3h13v8zM3.5 13h10v1h-2.584l1.504 2.326-.84.543L9.725 14H9v3H8v-3h-.712l-1.869 2.87-.838-.545L6.095 14H3.5v-1z"/></svg>
};
module.exports.BoltAlt = function BoltAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m11.83 8-3.826 7.233-.884-.467L10.17 9H5.061l4.9-7.279.829.559L6.939 8h4.891z"/></svg>
};
module.exports.Bolt = function Bolt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14.313 2.012H7.161L4.83 9.026h1.666l-2.01 6.052 9.483-8.051h-2.904l3.248-5.015zm-3.066 6.015L6.56 12.006l1.322-3.979H6.217l1.665-5.015h4.592L9.226 8.027h2.021z"/></svg>
};
module.exports.Book = function Book (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.592 1.152a17.77 17.77 0 0 0-2.981-.244c-2.105 0-3.828.366-5.125 1.088C6.968 1.231 5.222.844 3.29.844c-1.681 0-2.866.302-2.915.315L0 1.257l.001 13.906.624-.161c.011-.002 1.12-.283 2.665-.283 1.447 0 2.771.24 3.96.703v.828h2.5v-.856c1.281-.488 2.747-.611 3.86-.611 1.562 0 2.786.225 2.798.227l.592.11V1.229l-.408-.077zM1 13.907V2.049a12.77 12.77 0 0 1 2.29-.205c1.761 0 3.339.36 4.71 1.044v11.776c-1.403-.617-2.977-.945-4.71-.945-.969 0-1.773.101-2.29.188zm15 .031a18.844 18.844 0 0 0-2.39-.154c-1.848 0-3.381.298-4.61.855V2.866c1.422-.78 3.271-.958 4.61-.958 1.023 0 1.902.097 2.39.164v11.866z"/></svg>
};
module.exports.BookmarkAlt = function BookmarkAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M10.027 10.074V0H3.973v10.077l3.021-2.053 3.033 2.05zM4.973 8.188V1h4.055v7.191L6.991 6.815 4.973 8.188zM16 1.007V16H1V1.007h1.974v1H2V15h13V2.007h-4.005v-1H16z"/></svg>
};
module.exports.Bookmark = function Bookmark (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M3.562 1v15.459l4.686-3.27L13 16.449V1H3.562zM12 14.551l-3.756-2.578-3.681 2.568V2H12v12.551z"/></svg>
};
module.exports.Briefcase = function Briefcase (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M7 13v-1.5h1v.5h1v-.5h1V13H7zm10-2h-1v6H1v-6H0V3h3.616C4.554 1.17 6.421 0 8.5 0s3.947 1.171 4.884 3H17v8zM4.769 3h7.464c-.825-1.233-2.21-2-3.732-2s-2.907.768-3.732 2zM15 11H2v5h13v-5zm1-7H1v6h15V4z"/></svg>
};
module.exports.BrushAlt = function BrushAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 7.531c0-.827-.673-1.5-1.5-1.5h-4.808l.285-.914L11 1.5C11 .673 10.327 0 9.5 0h-2C6.673 0 6 .673 6 1.5v3.452l.31 1.08H1.5c-.827 0-1.5.673-1.5 1.5v3.486h.932L.166 17h16.668l-.766-5.982H17V7.531zM15.698 16H14v-2h-1v2h-1v-3h-1v3h-1v-4H9v4H4v-2H3v2H1.302l.638-4.982h13.12L15.698 16zM1.06 10.018H1V7.531a.5.5 0 0 1 .5-.5h6.165L7 4.876V1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v3.393l-.667 2.138H15.5a.5.5 0 0 1 .5.5v2.486H1.06zM8 2h1v1H8V2z"/></svg>
};
module.exports.Brush = function Brush (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m15.913 1.782-6.5 9.5-.825-.564 6.5-9.5.825.564zM9 13.992c0 1.103-.897 2-2 2-.203 0-.538.015-.541.015H1.005l4.553-3.431c.15-.104.859-.584 1.442-.584 1.103 0 2 .897 2 2zm-1 0c0-.551-.449-1-1-1-.175 0-.582.203-.853.393l-2.153 1.623h2.433c.063-.003.376-.016.573-.016.551 0 1-.449 1-1z"/></svg>
};
module.exports.Calendar = function Calendar (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14 2V1h-3v1H6V1H3v1H0v15h17V2h-3zm-2 0h1v2h-1V2zM4 2h1v2H4V2zm12 14H1V7.079h15V16zM1 6.079V3h2v2h3V3h5v2h3V3h2v3.079H1z"/></svg>
};
module.exports.Camera = function Camera (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M5.958 3V2H3.042v1H0v12h17V3H5.958zM16 14H1V7h6.557A3.953 3.953 0 0 0 7 9c0 2.206 1.794 4 4 4s4-1.794 4-4c0-.731-.212-1.409-.557-2H16v7zm-2-5c0 1.654-1.346 3-3 3s-3-1.346-3-3 1.346-3 3-3 3 1.346 3 3zm-.382-3c-.704-.614-1.612-1-2.618-1s-1.914.386-2.618 1H1V4h15v2h-2.382z"/></svg>
};
module.exports.Car = function Car (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m17 9.984-1.958.002L12.991 6H5.042L2.074 9.999 0 10v4.977h2.002L2 15c0 1.103.897 2 2 2s2-.897 2-2l-.002-.023h5.005c-.001.008-.003.015-.003.023 0 1.103.897 2 2 2s2-.897 2-2l-.002-.023H17V9.984zm-3.082.003-3.897.004V7h2.36l1.537 2.987zM5.544 7h3.477v2.992l-5.701.005L5.544 7zM4 16c-.551 0-1-.449-1-1s.449-1 1-1 1 .449 1 1-.449 1-1 1zm9 0c-.551 0-1-.449-1-1s.449-1 1-1 1 .449 1 1-.449 1-1 1zm3-2.023h-1.291C14.359 13.395 13.728 13 13 13s-1.359.395-1.709.977H5.709C5.359 13.395 4.728 13 4 13s-1.359.395-1.709.977H1V11l15-.015v2.992z"/></svg>
};
module.exports.CheckBox = function CheckBox (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14 5.761h1V16H1V2h8.393v1H2v12h12V5.761zM4.854 8.146l-.708.708 3.434 3.434L15.167.776l-.835-.551L7.42 10.713 4.854 8.146z"/></svg>
};
module.exports.Check = function Check (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.418 1.774 6.585 15.259l-4.918-4.386.666-.746 4.051 3.614 8.198-12.515.836.548z"/></svg>
};
module.exports.Clip = function Clip (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12.021 4.234v8.498h-1V4.234c0-1.091-.799-2.266-2.554-2.266-1.941 0-2.459 1.424-2.459 2.266v8.121h.007v1.457c0 .62.693 1.206 1.426 1.206.844 0 1.567-.683 1.567-1.241v-.27h-.003l.008-7.617c0-.874-.247-.874-.466-.874-.369 0-.547.035-.547.823v5.146H7V5.839c0-.451 0-1.823 1.547-1.823.669 0 1.466.325 1.466 1.875l-.007 6.43h.002v1.457c0 1.173-1.224 2.241-2.567 2.241-1.292 0-2.426-1.031-2.426-2.206v-.074h-.007V4.234C5.008 2.661 6.09.968 8.467.968c2.333.001 3.554 1.643 3.554 3.266z"/></svg>
};
module.exports.Clipboard = function Clipboard (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16 2v15H1V2h2.244v1H2v13h13V3h-1.278V2H16zm-3 3H4V1h3.085c.207-.582.763-1 1.415-1s1.208.418 1.415 1H13v4zm-1-3H9v-.5a.5.5 0 0 0-1 0V2H5v2h7V2z"/></svg>
};
module.exports.Close = function Close (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m9.207 8.5 6.646 6.646-.707.707L8.5 9.207l-6.646 6.646-.707-.707L7.793 8.5 1.146 1.854l.707-.707L8.5 7.793l6.646-6.646.707.707L9.207 8.5z"/></svg>
};
module.exports.CloudDown = function CloudDown (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 6.75A4.255 4.255 0 0 1 12.75 11H9.993v-1h2.757C14.542 10 16 8.542 16 6.75S14.542 3.5 12.75 3.5a3.22 3.22 0 0 0-1.56.417l-.354.195-.265-.306A3.744 3.744 0 0 0 7.75 2.5c-1.661 0-3.099 1.08-3.576 2.688l-.126.422-.435-.072c-.119-.019-.238-.038-.363-.038C2.01 5.5 1 6.509 1 7.75S2.01 10 3.25 10h3.699v1H3.25A3.254 3.254 0 0 1 0 7.75c0-1.826 1.511-3.335 3.353-3.248A4.702 4.702 0 0 1 7.75 1.5c1.234 0 2.42.494 3.309 1.367A4.115 4.115 0 0 1 12.75 2.5 4.255 4.255 0 0 1 17 6.75zm-8 6.98V6H8v7.73l-1.646-1.646-.707.707L8.5 15.644l2.854-2.854-.707-.707L9 13.73z"/></svg>
};
module.exports.CloudUp = function CloudUp (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 6.75A4.255 4.255 0 0 1 12.75 11H9.993v-1h2.757C14.542 10 16 8.542 16 6.75S14.542 3.5 12.75 3.5a3.22 3.22 0 0 0-1.56.417l-.354.195-.265-.306A3.744 3.744 0 0 0 7.75 2.5c-1.661 0-3.099 1.08-3.576 2.688l-.126.422-.435-.072c-.119-.019-.238-.038-.363-.038C2.01 5.5 1 6.509 1 7.75S2.01 10 3.25 10h3.699v1H3.25A3.254 3.254 0 0 1 0 7.75c0-1.826 1.529-3.335 3.353-3.248A4.702 4.702 0 0 1 7.75 1.5c1.234 0 2.42.494 3.309 1.367A4.115 4.115 0 0 1 12.75 2.5 4.255 4.255 0 0 1 17 6.75zm-6.354 2.104.707-.707L8.5 5.293 5.646 8.146l.707.707L8 7.207V15h1V7.207l1.646 1.647z"/></svg>
};
module.exports.Cloud = function Cloud (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12.75 4.5c-.578 0-1.146.123-1.691.367A4.728 4.728 0 0 0 7.75 3.5a4.702 4.702 0 0 0-4.397 3.002C1.55 6.428 0 7.923 0 9.75A3.254 3.254 0 0 0 3.25 13h9.5C15.093 13 17 11.093 17 8.75S15.093 4.5 12.75 4.5zm0 7.5h-9.5C2.009 12 1 10.991 1 9.75S2.009 7.5 3.25 7.5c.125 0 .244.019.363.038l.435.072.126-.422C4.652 5.58 6.089 4.5 7.75 4.5c1.073 0 2.102.477 2.821 1.307l.265.306.354-.195a3.208 3.208 0 0 1 1.56-.418C14.542 5.5 16 6.958 16 8.75S14.542 12 12.75 12z"/></svg>
};
module.exports.CommentAlt = function CommentAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.5 0h-14C.673 0 0 .673 0 1.5v10c0 .827.673 1.5 1.5 1.5H2v4.102L6.688 13H15.5c.827 0 1.5-.673 1.5-1.5v-10c0-.827-.673-1.5-1.5-1.5zm.5 11.5a.5.5 0 0 1-.5.5H6.312L3 14.898V12H1.5a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h14a.5.5 0 0 1 .5.5v10zM3 3h11v1H3V3zm0 2h11v1H3V5zm0 2h6v1H3V7z"/></svg>
};
module.exports.Comment = function Comment (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.5 0h-14C.673 0 0 .673 0 1.5v10c0 .827.673 1.5 1.5 1.5H2v4.102L6.688 13H15.5c.827 0 1.5-.673 1.5-1.5v-10c0-.827-.673-1.5-1.5-1.5zm.5 11.5a.5.5 0 0 1-.5.5H6.312L3 14.898V12H1.5a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h14a.5.5 0 0 1 .5.5v10z"/></svg>
};
module.exports.CommentsSmiley = function CommentsSmiley (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M13 8h1c0 2.481-2.019 4.5-4.5 4.5S5 10.481 5 8h1c0 1.93 1.57 3.5 3.5 3.5S13 9.93 13 8zM7.5 6.5a1 1 0 1 0 0-2 1 1 0 1 0 0 2zm4 0a1 1 0 1 0 0-2 1 1 0 1 0 0 2zm5.5 1c0 4.136-3.364 7.5-7.5 7.5a7.466 7.466 0 0 1-3.803-1.041l-5.5 2.843 2.843-5.499A7.475 7.475 0 0 1 2 7.5C2 3.364 5.364 0 9.5 0S17 3.364 17 7.5zm-1 0C16 3.916 13.084 1 9.5 1S3 3.916 3 7.5c0 1.244.358 2.459 1.036 3.511l.157.243-1.664 3.218 3.217-1.664.243.157A6.479 6.479 0 0 0 9.5 14c3.584 0 6.5-2.916 6.5-6.5z"/></svg>
};
module.exports.Comments = function Comments (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 1.5v7.969c0 .827-.673 1.5-1.5 1.5h-.508v-1h.508a.5.5 0 0 0 .5-.5V1.5a.5.5 0 0 0-.5-.5h-14a.5.5 0 0 0-.5.5v7.969a.5.5 0 0 0 .5.5H3v2.892l1.779-1.569.661.75L2 15.077v-4.108h-.5c-.827 0-1.5-.673-1.5-1.5V1.5C0 .673.673 0 1.5 0h14c.827 0 1.5.673 1.5 1.5zm-2.98 8.04v3.043c0 .827-.673 1.5-1.5 1.5h-.5v3.064l-3.667-3.064H7.5c-.827 0-1.5-.673-1.5-1.5V9.54c0-.827.673-1.5 1.5-1.5h5.02c.827 0 1.5.673 1.5 1.5zm-1 0a.5.5 0 0 0-.5-.5H7.5a.5.5 0 0 0-.5.5v3.043a.5.5 0 0 0 .5.5h1.217l2.303 1.926v-1.926h1.5a.5.5 0 0 0 .5-.5V9.54z"/></svg>
};
module.exports.ControlBackward = function ControlBackward (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M6.719 8.474 14 14.571V2.436L6.719 8.474zM13 12.429 8.281 8.478 13 4.564v7.865zM3.281 8.478l5.54 4.639-.643.768-6.46-5.41L8.18 3.117l.639.77-5.538 4.591z"/></svg>
};
module.exports.ControlEject = function ControlEject (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.474 2.719 2.436 10h12.135L8.474 2.719zm.004 1.562L12.429 9H4.564l3.914-4.719zM15 13v1H2v-1h13z"/></svg>
};
module.exports.ControlForward = function ControlForward (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M3 2.436v12.136l7.281-6.098L3 2.436zm1 2.128 4.719 3.913L4 12.429V4.564zm11.281 3.91-6.46 5.41-.643-.768 5.54-4.639-5.537-4.592.639-.77 6.461 5.359z"/></svg>
};
module.exports.ControlPause = function ControlPause (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M3 15h4V2H3v13zM4 3h2v11H4V3zm6-1v13h4V2h-4zm3 12h-2V3h2v11z"/></svg>
};
module.exports.ControlPlay = function ControlPlay (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M3 2.692V14.31l11.618-5.837L3 2.692zm1 1.616 8.382 4.17L4 12.689V4.308z"/></svg>
};
module.exports.ControlRecord = function ControlRecord (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5 2.5c-3.309 0-6 2.691-6 6s2.691 6 6 6 6-2.691 6-6-2.691-6-6-6zm0 11c-2.757 0-5-2.243-5-5s2.243-5 5-5 5 2.243 5 5-2.243 5-5 5z"/></svg>
};
module.exports.ControlShuffle = function ControlShuffle (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m8.94 6.871 1.081-1.34-.004-.003A4.504 4.504 0 0 1 13.395 4h1.898l-1.646-1.646.707-.707L17.207 4.5l-2.854 2.854-.707-.707L15.293 5h-1.898c-.989 0-1.931.425-2.595 1.159L9.72 7.498l-.78-.627zm-3.089 3.825-.011-.008A3.484 3.484 0 0 1 3.107 12H0v1h3.107a4.477 4.477 0 0 0 3.503-1.676l.011.009.941-1.166-.777-.629-.934 1.158zm7.795-.342L15.293 12h-1.898a3.484 3.484 0 0 1-2.7-1.281L6.426 5.454l-.01.008A4.496 4.496 0 0 0 3.107 4H0v1h3.107c.998 0 1.948.428 2.611 1.17l4.161 5.132-.005.004A4.485 4.485 0 0 0 13.394 13h1.898l-1.646 1.646.707.707 2.854-2.854-2.854-2.854-.707.709z"/></svg>
};
module.exports.ControlSkipBackward = function ControlSkipBackward (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M6.719 8.526 14 14.564V2.429L6.719 8.526zM13 12.436 8.281 8.522 13 4.571v7.865zM3 2h1v13H3V2z"/></svg>
};
module.exports.ControlSkipForward = function ControlSkipForward (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m3 14.571 7.281-6.097L3 2.436v12.135zM4 4.564l4.719 3.914L4 12.429V4.564zM14 2v13h-1V2h1z"/></svg>
};
module.exports.ControlStop = function ControlStop (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M3 3v11h11V3H3zm10 10H4V4h9v9z"/></svg>
};
module.exports.CreditCard = function CreditCard (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.5 2h-14C.673 2 0 2.673 0 3.5v10c0 .827.673 1.5 1.5 1.5h14c.827 0 1.5-.673 1.5-1.5v-10c0-.827-.673-1.5-1.5-1.5zm.5 11.5a.5.5 0 0 1-.5.5h-14a.5.5 0 0 1-.5-.5V8h15v5.5zM1 5V3.5a.5.5 0 0 1 .5-.5h14a.5.5 0 0 1 .5.5V5H1z"/></svg>
};
module.exports.Crown = function Crown (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12.626 6.743 8.543.07 4.332 6.745-.167 2.912 1.572 16h13.855l1.738-13.075-4.539 3.818zM2.447 15l-.133-1h12.371l-.133 1H2.447zm12.371-2H2.182L1.167 5.363l3.396 2.892 3.967-6.29 3.851 6.292 3.454-2.906L14.818 13z"/></svg>
};
module.exports.Css3 = function Css3 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m16.5 1.26-2.407 12.064-7.277 2.416L.5 13.324l.643-3.223h2.688l-.263 1.33 3.818 1.457 4.398-1.457.614-3.068H1.469l.524-2.686h10.94l.345-1.73H2.347L2.88 1.26H16.5z"/></svg>
};
module.exports.Cup = function Cup (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.999 1h-2.257c.001-.168.008-.328.008-.5V0H2.25v.5c0 .16.004.333.005.5H.001L0 1.499a27.312 27.312 0 0 0 .195 3.31c.352 2.937 1.271 6.341 2.795 7.087.194.096.395.144.596.144.238 0 .479-.068.707-.206l.209-.14c.833 1.277 1.97 2.139 3.498 2.298V16H5.047v1h7v-1H9v-1.997c1.415-.149 2.585-.935 3.493-2.312l.234.155a1.31 1.31 0 0 0 1.283.049c1.524-.746 2.443-4.15 2.795-7.087A27.3 27.3 0 0 0 17 1.498L16.999 1zM3.988 10.834l-.229.154c-.112.066-.204.07-.328.01-.785-.385-1.808-2.675-2.243-6.309-.108-.9-.169-1.802-.184-2.689h1.273c.097 2.924.513 6.468 1.792 8.956l-.081-.122zM8.5 13.041c-4.54 0-5.199-8.05-5.247-12.041h10.494c-.049 4.721-.838 12.041-5.247 12.041zm7.312-8.352c-.436 3.634-1.458 5.924-2.243 6.309-.123.061-.216.058-.308.003l-.25-.167-.116.174C13.974 8.97 14.602 5.942 14.726 2h1.271a26.66 26.66 0 0 1-.185 2.689z"/></svg>
};
module.exports.Cut = function Cut (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M13 11c-.545 0-1.049.157-1.49.412L9.188 8.958l6.26-6.614-.727-.688L8.5 8.23 2.277 1.656l-.726.688 6.26 6.614-2.322 2.453A2.969 2.969 0 0 0 4 11c-1.654 0-3 1.346-3 3s1.346 3 3 3 3-1.346 3-3c0-.747-.285-1.424-.738-1.949L8.5 9.686l2.238 2.365A2.973 2.973 0 0 0 10 14c0 1.654 1.346 3 3 3s3-1.346 3-3-1.346-3-3-3zm-9 5c-1.103 0-2-.897-2-2s.897-2 2-2 2 .897 2 2-.897 2-2 2zm9 0c-1.103 0-2-.897-2-2s.897-2 2-2 2 .897 2 2-.897 2-2 2z"/></svg>
};
module.exports.Dashboard = function Dashboard (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 11.5v.5h-6.168v-1h5.152a7.47 7.47 0 0 0-1.842-4.434l-.806.806-.707-.707.802-.802A7.464 7.464 0 0 0 9 4.024V7H8V4.024a7.459 7.459 0 0 0-4.43 1.839l.796.796-.707.707-.8-.8A7.463 7.463 0 0 0 1.017 11h5.171v1H0v-.5C0 6.813 3.813 3 8.5 3S17 6.813 17 11.5zm-6.5 0c0 1.103-.897 2-2 2s-2-.897-2-2c0-.644.311-1.21.784-1.577l-2.082-3.63.867-.497L8.21 9.529c.095-.014.19-.029.29-.029 1.103 0 2 .897 2 2zm-1 0c0-.551-.449-1-1-1s-1 .449-1 1 .449 1 1 1 1-.449 1-1z"/></svg>
};
module.exports.Desktop = function Desktop (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M2 11h13V3H2v8zm1-7h11v6H3V4zm12.5-3h-14C.673 1 0 1.638 0 2.423v10.154C0 13.362.673 14 1.5 14h14c.827 0 1.5-.638 1.5-1.423V2.423C17 1.638 16.327 1 15.5 1zm.5 11.577c0 .234-.225.423-.5.423h-14c-.275 0-.5-.189-.5-.423V2.423C1 2.189 1.225 2 1.5 2h14c.275 0 .5.189.5.423v10.154zM5 15h7v1H5v-1z"/></svg>
};
module.exports.DirectionAlt = function DirectionAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M9 6h4.695l1.938-2.563L13.687 1H9V0H8v1H2v5h6v2H3.313l-1.946 2.437L3.305 13H8v4h1v-4h6V8H9V6zM3 2h10.206l1.161 1.454L13.198 5H3V2zm11 10H3.802l-1.169-1.546L3.794 9H14v3z"/></svg>
};
module.exports.Direction = function Direction (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.641 5.409 13.83 2H9V0H8v2H1v7h7v8h1V9h4.838l2.803-3.591zM9 8H2V3h11.358l2.001 2.426L13.35 8H9z"/></svg>
};
module.exports.Download = function Download (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 16v1H0v-1h17zm-3.646-7.146-.707-.707-3.646 3.646V0h-1v11.794L4.354 8.146l-.708.708L8.5 13.707l4.854-4.853z"/></svg>
};
module.exports.Dribbble = function Dribbble (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5 0a8.5 8.5 0 1 0 .001 17.001A8.5 8.5 0 0 0 8.5 0zm7.494 8.621c-2.075-.456-3.896-.423-5.469-.092a33.17 33.17 0 0 0-.849-1.93c1.681-.648 3.292-1.586 4.548-2.934A7.465 7.465 0 0 1 16 8.5c0 .041-.006.08-.006.121zm-2.471-5.674c-1.16 1.257-2.688 2.135-4.297 2.74a27.504 27.504 0 0 0-2.814-4.385A7.464 7.464 0 0 1 8.5 1a7.46 7.46 0 0 1 5.023 1.947zM5.43 1.665a25.94 25.94 0 0 1 2.828 4.353c-2.974.92-5.966 1.028-7.114 1.03A7.516 7.516 0 0 1 5.43 1.665zM1 8.5c0-.151.014-.3.022-.449l.212.001c1.306 0 4.402-.125 7.482-1.114.3.625.578 1.245.82 1.844-3.605 1.101-5.736 3.705-6.513 4.826A7.462 7.462 0 0 1 1 8.5zm2.758 5.804c.596-.901 2.601-3.518 6.145-4.57.961 2.598 1.405 4.744 1.566 5.651A7.46 7.46 0 0 1 8.5 16a7.46 7.46 0 0 1-4.742-1.696zm8.642.59a34.174 34.174 0 0 0-1.503-5.405c1.444-.28 3.109-.288 5.008.145a7.507 7.507 0 0 1-3.505 5.26z"/></svg>
};
module.exports.DropboxAlt = function DropboxAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m.5 9.344 4.707 3.07L8.5 9.668l-4.745-2.93zM5.207 1.062.5 4.133l3.255 2.605L8.5 3.811zM16.5 4.133l-4.706-3.071L8.5 3.811l4.746 2.927zM8.5 9.668l3.294 2.746 4.706-3.07-3.254-2.606z"/><path d="m8.51 10.259-3.303 2.739-1.413-.924v1.035l4.716 2.829 4.717-2.829v-1.035l-1.414.924z"/></svg>
};
module.exports.Dropbox = function Dropbox (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.853 4.371 11.557.917 8.5 3.455 5.454.917.147 4.371l3.1 2.476L.148 9.329l3.444 2.243v1.533l4.917 2.939 4.926-2.938v-1.548l3.417-2.23-3.098-2.481 3.099-2.476zm-5.226-2.214 3.52 2.296-2.232 1.782-3.56-2.19 2.272-1.888zM12 6.847 8.5 9.006 5 6.847l3.5-2.154L12 6.847zM1.853 4.453 5.38 2.157l2.265 1.887-3.561 2.191-2.231-1.782zm-.001 4.792 2.232-1.789 3.562 2.198-2.266 1.89-3.528-2.299zm10.583 3.293L8.51 14.881l-3.917-2.342v-.315l.862.561 3.047-2.54 3.056 2.54.878-.573v.326zm2.713-3.292-3.521 2.298-2.273-1.89 3.561-2.198 2.233 1.79z"/></svg>
};
module.exports.Drupal = function Drupal (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.563 16.5c-3.718 0-7.062-2.926-7.062-6.906 0-3.974 3.098-5.813 3.672-6.114.684-.364 1.176-.556 1.95-1.175.383-.301.702-.739.803-1.805.555.665 1.221 1.439 1.694 1.759.775.51 1.55.711 2.36 1.221.492.301 3.518 2.15 3.518 6.241 0 4.082-3.226 6.779-6.935 6.779zm5.467-6.597c-.729 0-2.205 1.513-2.979 1.522-.901.018-2.149-1.787-3.954-1.77-1.422.01-2.542 1.14-2.561 2.343-.009.675.21 1.176.675 1.494.31.209.592.337 1.512.337 1.531 0 3.472-1.896 4.365-1.867.71.026 1.812 1.768 2.369 1.804.437.036.665-.164 1.038-.701.364-.547.52-1.404.52-1.887 0-.473-.21-1.275-.985-1.275zm-2.113 4.838c-.31.228-1.003.511-1.987.511s-1.448-.21-1.758-.447c-.045-.036-.027-.036-.119-.036-.1 0-.154.046-.236.109a.23.23 0 0 0 0 .328c.674.619 1.804.565 2.633.491.839-.082 1.55-.573 1.622-.646.109-.108.082-.2.063-.264-.018-.064-.073-.154-.218-.046zm-.493-1.557c-.182-.118-.445-.137-.691-.137-.247 0-.383-.018-.646.091-.266.109-.539.355-.711.511-.174.154-.201.273-.11.401.092.117.192.044.447-.174.264-.21.438-.401.975-.401s.629.201.737.401c.11.2.119.228.228.174.128-.064.192-.156.128-.312-.065-.154-.174-.427-.357-.554z"/></svg>
};
module.exports.Email = function Email (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 2v13h17V2H0zm8.494 7.817L1.598 3h13.82L8.494 9.817zM5.755 8.516 1 13.198V3.815l4.755 4.701zm.711.703 2.026 2.003 1.996-1.966 4.8 4.744H1.611l4.855-4.781zm4.735-.664L16 3.83v9.467l-4.799-4.742z"/></svg>
};
module.exports.Envelope = function Envelope (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M2 0v17h13V0H2zm2.695 4L3.287 1h10.426l-1.41 3H4.695zm-.634 1H8v9H3.998L3 15.155V2.741L4.061 5zm.394 10h8.092l.862 1H3.593l.862-1zm8.551-1H9V5h3.938L14 2.739v12.415L13.006 14z"/></svg>
};
module.exports.Eraser = function Eraser (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M13.446 4.201 8.25 1.2c-.69-.397-1.65-.141-2.048.55l-6 10.393a1.503 1.503 0 0 0 .55 2.05l3.179 1.824 4.357-.018 5.708-9.749a1.502 1.502 0 0 0-.55-2.049zm-5.733 10.8-3.518.014-2.945-1.689a.501.501 0 0 1-.183-.684l2.75-4.764 6.027 3.48-2.131 3.643zm5.417-9.254-2.781 4.75-6.032-3.483 2.75-4.764a.503.503 0 0 1 .683-.184l5.196 3a.5.5 0 0 1 .184.681zM17 15v1h-7v-1h7z"/></svg>
};
module.exports.ExchangeVertical = function ExchangeVertical (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M6 15.043V8H5v7.043l-3.646-3.646-.707.707L5.5 16.957l4.854-4.854-.707-.707L6 15.043zm-.512.488h.023l-.011.012-.012-.012zm10.158-9.927L12 1.957v7.096h-1V1.957L7.354 5.604l-.708-.708L11.5.043l4.854 4.854-.708.707z"/></svg>
};
module.exports.Export = function Export (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m4.359 5.956-.718-.697L8.5.254l4.859 5.005-.718.696L9 2.205v10.767H8V2.205L4.359 5.956zM16 9.03v6.47a.5.5 0 0 1-.5.5h-14a.5.5 0 0 1-.5-.5V9.025H0V15.5c0 .827.673 1.5 1.5 1.5h14c.827 0 1.5-.673 1.5-1.5V9.03h-1z"/></svg>
};
...
module.exports.Facebook = function Facebook (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m12.461 5.57-.309 2.93H9.81V17H6.292V8.5H4.539V5.57h1.753V3.806C6.292 1.423 7.283 0 10.1 0h2.341v2.93h-1.465c-1.093 0-1.166.413-1.166 1.176V5.57h2.651z"/></svg>
};
module.exports.File = function File (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M9.667 0H2v17h13V5.308L9.667 0zM10 1.742 13.273 5H10V1.742zM3 16V1h6v5h5v10H3z"/></svg>
};
module.exports.Files = function Files (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12.497 0H6v2.01h1V1h5v4h4v8h-4.017v1H17V4.182L12.497 0zM13 1.832 15.335 4H13V1.832zM0 3v14h11V7.182L6.497 3H0zm7 1.832L9.335 7H7V4.832zM1 16V4h5v4h4v8H1z"/></svg>
};
module.exports.Filter = function Filter (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M.54 0 7 9.229V17h3V9.229L16.46 0H.54zM9 8.914V16H8V8.914L2.46 1h12.08L9 8.914z"/></svg>
};
module.exports.FlagAlt2 = function FlagAlt2 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 0v17h-1V0h1zM4.984 1h8v8H8v2H1V3h3.984V1zM7 9H5V4H2v6h5V9zM5.984 2v1H6v5h5.984V2h-6z"/></svg>
};
module.exports.FlagAlt = function FlagAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 0v17h-1V0h1zM1.527.976H13v8H1.51l2.911-3.952L1.527.976zm10.473 1H3.472l2.185 3.056-2.168 2.944H12v-6z"/></svg>
};
module.exports.Flag = function Flag (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M13 10.008V.77L1.121 5.389 13 10.008zm-1-1.461L3.879 5.389 12 2.23v6.317zM15 0v17h-1V0h1z"/></svg>
};
module.exports.FlickrAlt = function FlickrAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5.5a8.001 8.001 0 0 0 0 16 8 8 0 0 0 0-16zM5.433 10.979a2.518 2.518 0 1 1-.002-5.036 2.518 2.518 0 0 1 .002 5.036zm6.317 0a2.517 2.517 0 1 1 0-5.036 2.518 2.518 0 1 1 0 5.036z"/></svg>
};
...
module.exports.HeartBroken = function HeartBroken (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M.153 6.276A4.53 4.53 0 0 1 0 5.158c0-2.481 2.019-4.5 4.5-4.5 1.739 0 3.251.992 4 2.439a4.506 4.506 0 0 1 4-2.439c2.481 0 4.5 2.019 4.5 4.5 0 .342-.047.688-.147 1.091l-.113.368c-.081.331-.228.721-.453 1.199l-.904-.426c.196-.418.322-.749.395-1.041l.112-.369c.073-.295.11-.564.11-.822 0-1.93-1.57-3.5-3.5-3.5S9 3.229 9 5.158H8c0-1.93-1.57-3.5-3.5-3.5S1 3.229 1 5.158c0 .259.038.536.116.847l.1.316c.094.287.235.618.441 1.033L.761 7.8a8.975 8.975 0 0 1-.498-1.173l-.11-.351zm8.346 8.935c-.806-.633-3.102-2.533-4.976-5.013l-.797.604c2.394 3.167 5.354 5.352 5.478 5.443l.298.218.296-.22c.129-.095 3.187-2.374 5.536-5.438l-.793-.609c-1.848 2.409-4.219 4.366-5.042 5.015zm5.673-7.796-2.832 2-2.832-2-2.833 2-2.837-1.999-3.126 2.202.576.818 2.55-1.798 2.837 2.001 2.833-2 2.832 2 2.832-2 2.539 1.796.578-.816-3.117-2.204z"/></svg>
};
module.exports.Heart = function Heart (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12.5.658a4.506 4.506 0 0 0-4 2.439 4.506 4.506 0 0 0-4-2.439 4.505 4.505 0 0 0-4.5 4.5c0 .343.048.699.154 1.118l.109.351c1.432 4.354 7.659 9.393 7.924 9.604l.313.252.313-.252c.282-.227 6.926-5.598 7.927-9.614l.112-.368c.101-.402.148-.749.148-1.091 0-2.481-2.019-4.5-4.5-4.5zm3.389 5.322-.113.37c-.809 3.246-5.946 7.727-7.276 8.843-1.282-1.083-6.122-5.337-7.285-8.872l-.1-.316A3.517 3.517 0 0 1 1 5.158c0-1.93 1.57-3.5 3.5-3.5S8 3.229 8 5.158v.252h1v-.252c0-1.93 1.57-3.5 3.5-3.5s3.5 1.57 3.5 3.5c0 .258-.038.527-.111.822z"/></svg>
};
module.exports.HelpAlt = function HelpAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5 0C3.813 0 0 3.813 0 8.5S3.813 17 8.5 17 17 13.187 17 8.5 13.187 0 8.5 0zm0 16C4.364 16 1 12.636 1 8.5S4.364 1 8.5 1 16 4.364 16 8.5 12.636 16 8.5 16zm1.158-3.781a1.032 1.032 0 1 1-2.064-.002 1.032 1.032 0 0 1 2.064.002zm1.004-8.004c.448.565.674 1.328.55 1.855-.243 1.027-.842 1.567-1.371 2.043-.543.489-.934.84-.934 1.647h-1c0-1.251.671-1.856 1.264-2.39.461-.415.896-.807 1.066-1.529.034-.143-.039-.6-.36-1.005-.307-.389-.728-.586-1.248-.586-1.779 0-1.869 1.444-1.873 1.609l-1-.027c.024-.893.655-2.582 2.873-2.582.818 0 1.539.343 2.033.965z"/></svg>
};
module.exports.Help = function Help (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M10.311 14.831a1.63 1.63 0 1 1-3.26-.003 1.63 1.63 0 0 1 3.26.003zm1.357-12.458C11.156 1.728 10.224.959 8.685.959c-4.098 0-4.245 3.758-4.246 3.796l1 .026c.003-.115.11-2.822 3.246-2.822 1.14 0 1.825.563 2.199 1.035.555.7.7 1.508.624 1.833-.291 1.229-1.011 1.877-1.773 2.563-.935.841-1.9 1.71-1.9 3.558h1c0-1.402.692-2.026 1.569-2.815.804-.724 1.715-1.544 2.077-3.078.149-.634-.083-1.76-.813-2.682z"/></svg>
};
module.exports.Home = function Home (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14 16h-3v-6H6v6H3V7H2v10h13V7h-1v9zm-7 0v-5h3v5H7zm9.796-9.527-.592.807L8.5 1.62.796 7.278l-.592-.806L8.5.38l8.296 6.093z"/></svg>
};
module.exports.Html5 = function Html5 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m15.54.5-1.28 14.379L8.48 16.5l-5.74-1.621L1.46.5h14.08zm-2.62 2.939H4.08l.47 5.34h6.121l-.222 2.279-1.969.532-1.96-.531-.13-1.399H4.641l.22 2.779 3.62 1h.039v-.01l3.591-.99.5-5.44H6.17l-.15-1.81h6.74l.16-1.75z"/></svg>
};
module.exports.Hummer = function Hummer (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M9 4h5.625l-3.609-4H4v4h4v3.723H6.875V17h3.25V7.723H9V4zM5 1h5.571l1.805 2H5V1zm4.125 15h-1.25V8.723h1.25V16z"/></svg>
};
module.exports.IdBadge = function IdBadge (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 3v12h17V3H0zm16 11H1V4h15v10zm-13.438-.489-1-.022c.033-1.43 1.398-2.652 3.309-3.017v-.326c-.248-.259-.425-.61-.545-.923a1.239 1.239 0 0 1-.399-.516c-.185-.41-.153-.821.063-1.068a4.04 4.04 0 0 1-.006-.217l-.002-.184c-.006-.537-.016-1.42.929-1.584.194-.339.483-.627 1.179-.651 1.123-.035 1.916.378 2.185 1.151.091.265.006.485-.056.645-.059.152-.115.295-.082.564.013.107.011.212.003.312.175.237.211.597.082.975-.095.273-.249.484-.434.608-.111.287-.27.604-.487.845v.377c1.909.375 3.228 1.571 3.261 3.008l-1 .023c-.023-1.021-1.21-1.908-2.823-2.109l-.438-.055V9.638l.2-.15c.106-.08.271-.321.415-.761l.135-.344.074-.631c.014-.106.027-.207.019-.268-.062-.52.066-.85.142-1.046l.012-.031c-.21-.396-.879-.413-1.171-.406-.277.011-.297.05-.351.153-.068.132-.229.442-.637.478-.092.008-.121.027-.121.027-.041.064-.038.367-.036.568l.001.195c0 .141.01.292.029.446l.07.573.12.021.003.248c.154.466.339.721.451.798l.215.149v1.687l-.442.052c-1.612.189-2.844 1.098-2.867 2.115zM15 8h-5V7h5v1zm-1 2h-4V9h4v1z"/></svg>
};
module.exports.Image = function Image (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M1 1v15h15V1H1zm14 14H2v-2h13v2zM2 12V2h13v10H2zm12.203-1.835-.697.717-2.417-2.349-1.554 1.676-2.486-4.415-3.401 4.975-.826-.564 4.31-6.303 2.604 4.622 1.317-1.422 3.15 3.063z"/></svg>
};
module.exports.Import = function Import (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m8.5 13.677-4.853-4.83.705-.709L8 11.769V.972h1v10.797l3.647-3.63.705.709L8.5 13.677zM16 9.03v6.47a.5.5 0 0 1-.5.5h-14a.5.5 0 0 1-.5-.5V9.025H0V15.5c0 .827.673 1.5 1.5 1.5h14c.827 0 1.5-.673 1.5-1.5V9.03h-1z"/></svg>
};
module.exports.Infinite = function Infinite (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 8c0 2.206-1.794 4-4 4a3.98 3.98 0 0 1-3.074-1.452l-.002.001-.014-.018c-.011-.014-.026-.023-.038-.038l.004-.003-3.634-4.482A3.003 3.003 0 0 0 4 5C2.346 5 1 6.346 1 8s1.346 3 3 3c.915 0 1.769-.41 2.342-1.125l.009.007.817-1.012.778.628-.823 1.019-.01-.008A3.98 3.98 0 0 1 4 12c-2.206 0-4-1.794-4-4s1.794-4 4-4c1.12 0 2.186.477 2.943 1.301l.008-.006.042.052 3.698 4.56A2.983 2.983 0 0 0 13 11c1.654 0 3-1.346 3-3s-1.346-3-3-3c-.846 0-1.65.362-2.22.989l-.948 1.175-.778-.628.948-1.175-.004-.003A4.003 4.003 0 0 1 13 4c2.206 0 4 1.794 4 4z"/></svg>
};
module.exports.InfoAlt = function InfoAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5 0C3.813 0 0 3.813 0 8.5S3.813 17 8.5 17 17 13.187 17 8.5 13.187 0 8.5 0zm0 16C4.364 16 1 12.636 1 8.5S4.364 1 8.5 1 16 4.364 16 8.5 12.636 16 8.5 16zm.5-3.631h.979v1H7.021v-1H8v-4.42h-.946v-1H9v5.42zM7.185 4.986a.985.985 0 1 1 1.97-.001.985.985 0 0 1-1.97.001z"/></svg>
};
module.exports.Info = function Info (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M10.8 14.276v1H6.2v-1H8V6.845H6.25v-1H9v8.431h1.8zM7.988 4.045A1.533 1.533 0 1 0 7.987.978a1.533 1.533 0 0 0 .001 3.067z"/></svg>
};
module.exports.InkPen = function InkPen (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M3 0v6.499l5.466 9.499L14 6.5V0H3zm5.471 14h.002l-.001.002L8.471 14zM8.5 6a1.001 1.001 0 0 1 0-2 1.001 1.001 0 0 1 0 2zm4.5.23-4 6.866V6.929c.86-.223 1.5-1 1.5-1.929 0-1.103-.897-2-2-2s-2 .897-2 2c0 .929.64 1.706 1.5 1.929v6.254L4 6.231V1h9v5.23z"/></svg>
};
module.exports.Instagram = function Instagram (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M13 0H4C1.8 0 0 1.8 0 4v9c0 2.2 1.8 4 4 4h9c2.2 0 4-1.8 4-4V4c0-2.2-1.8-4-4-4zm3 13c0 1.654-1.346 3-3 3H4c-1.654 0-3-1.346-3-3V7h3.207a4.691 4.691 0 0 0-.457 2c0 2.619 2.131 4.75 4.75 4.75s4.75-2.131 4.75-4.75c0-.717-.171-1.39-.457-2H16v6zm-3.75-4c0 2.068-1.682 3.75-3.75 3.75S4.75 11.068 4.75 9 6.432 5.25 8.5 5.25 12.25 6.932 12.25 9zm-.098-3C11.28 4.941 9.976 4.25 8.5 4.25S5.72 4.941 4.848 6H1V4c0-1.654 1.346-3 3-3h9c1.654 0 3 1.346 3 3v2h-3.848zm2.302-3.278V4.02a.544.544 0 0 1-.542.543h-1.368A.546.546 0 0 1 12 4.02V2.722c0-.299.244-.543.544-.543h1.368c.298 0 .542.244.542.543z"/></svg>
};
module.exports.Italic = function Italic (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M11.895 2.014 6.204 15H7v1H4v-1h1.111l5.691-12.986H10v-1h3v1h-1.105z"/></svg>
};
module.exports.Joomla = function Joomla (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m9.979 12.011-1.573 1.583-.312.312a3.552 3.552 0 0 1-3.364.927 2.142 2.142 0 0 1-4.23-.479c0-1.009.698-1.864 1.646-2.082a3.533 3.533 0 0 1 .927-3.386l.125-.125 1.573 1.584-.114.114c-.521.51-.51 1.343 0 1.863.51.511 1.344.511 1.854 0l.313-.312 1.573-1.584 1.677-1.666 1.573 1.584-1.668 1.667zm-1.76-8.646L6.636 4.947l-.126-.125a1.315 1.315 0 0 0-1.854 0 1.328 1.328 0 0 0 0 1.865l3.552 3.552-1.572 1.583-1.677-1.667-1.573-1.582-.313-.312c-.959-.948-1.25-2.313-.886-3.532A2.124 2.124 0 0 1 .521 2.646a2.14 2.14 0 0 1 4.25-.354 3.57 3.57 0 0 1 3.323.947l.125.126zm6.406 1.406a3.546 3.546 0 0 1-.906 3.489l-.125.125-1.573-1.584.125-.124c.51-.511.51-1.345 0-1.855a1.315 1.315 0 0 0-1.854 0L6.729 8.386 5.146 6.802l1.677-1.667 1.583-1.582.302-.313a3.548 3.548 0 0 1 3.511-.895 2.142 2.142 0 0 1 4.261.301 2.156 2.156 0 0 1-1.855 2.125zM14.364 16.5a2.146 2.146 0 0 1-2.104-1.719 3.547 3.547 0 0 1-3.552-.875l-.114-.125 1.573-1.583.125.124c.51.511 1.344.511 1.854 0 .51-.51.51-1.343 0-1.854l-.312-.313-3.251-3.249 1.583-1.584 3.25 3.251.303.312a3.532 3.532 0 0 1 .937 3.354 2.141 2.141 0 0 1-.292 4.261z"/></svg>
};
module.exports.Jsfiddle = function Jsfiddle (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.5 10.867c0 1.711-1.414 3.102-3.148 3.102-.062 0-.117-.008-.172-.008H3.672C1.922 13.859.5 12.523.5 10.789c0-1.164.633-2.18 1.578-2.734a2.17 2.17 0 0 1-.094-.641c0-1.195.977-2.164 2.195-2.164.5 0 .969.172 1.344.453a4.754 4.754 0 0 1 4.289-2.672c2.633 0 4.758 2.102 4.758 4.688 0 .094-.008.188-.008.281 1.133.469 1.938 1.578 1.938 2.867zM6.438 12.141c.766 0 1.32-.242 1.875-.773-.227-.281-.477-.555-.711-.836-.32.312-.672.508-1.125.508-.555 0-1.031-.367-1.031-.945 0-.57.477-.945 1.016-.945 1.719 0 2.086 3 4.586 3 1.219 0 2.25-.766 2.25-2.047 0-1.297-1.039-2.055-2.273-2.055-.766 0-1.336.219-1.883.758.25.273.484.562.727.844.312-.305.664-.5 1.109-.5.516 0 1.031.367 1.031.914 0 .602-.438.984-1.023.984-1.664 0-2.109-3-4.547-3-1.211 0-2.281.742-2.281 2.031-.002 1.319 1.037 2.062 2.28 2.062z"/></svg>
};
module.exports.Key = function Key (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m14.811 6.299.707-.707-1.733-1.733.757-.753-.705-.709-8.146 8.107a2.976 2.976 0 0 0-1.703-.535c-1.654 0-3 1.346-3 3s1.346 3 3 3 3-1.346 3-3c0-.661-.222-1.268-.585-1.764l5.264-5.238 1.738 1.738.707-.707-1.737-1.736.701-.698 1.735 1.735zm-10.824 8.67c-1.103 0-2-.897-2-2s.897-2 2-2 2 .897 2 2-.897 2-2 2z"/></svg>
};
module.exports.LayersAlt = function LayersAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M11 1H0v9h11V1zm-1 8H1V2h9v7zm4 4H3v-1.981h1V12h9V5h-.994V4H14v9zm3-6v9H6v-1.981h1V15h9V8h-.994V7H17z"/></svg>
};
module.exports.Layers = function Layers (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M13 1H0v11h13V1zm-1 10H1V2h11v9zm5-6v11H4v-3.031h1V15h11V6h-2.016V5H17z"/></svg>
};
module.exports.LayoutAccordionList = function LayoutAccordionList (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M4 0v9h13V0H4zm12 8H5V1h11v7zM0 3h3V0H0v3zm1-2h1v1H1V1zm3 12h13v-3H4v3zm1-2h11v1H5v-1zm-5 2h3v-3H0v3zm1-2h1v1H1v-1zm3 6h13v-3H4v3zm1-2h11v1H5v-1zm-5 2h3v-3H0v3zm1-2h1v1H1v-1z"/></svg>
};
module.exports.LayoutAccordionMerged = function LayoutAccordionMerged (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0v17h17V0H0zm16 1v9H1V1h15zm0 10v2H1v-2h15zM1 16v-2h15v2H1z"/></svg>
};
module.exports.LayoutAccordionSeparated = function LayoutAccordionSeparated (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0v3h17V0H0zm16 2H1V1h15v1zM0 13h17V4H0v9zm1-8h15v7H1V5zM0 17h17v-3H0v3zm1-2h15v1H1v-1z"/></svg>
};
module.exports.LayoutColumn2Alt = function LayoutColumn2Alt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0h8v17H0V0zm9 0v17h8V0H9z"/></svg>
};
module.exports.LayoutColumn2 = function LayoutColumn2 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 17h8V0H0v17zM1 1h6v15H1V1zm8-1v17h8V0H9zm7 16h-6V1h6v15z"/></svg>
};
module.exports.LayoutColumn3Alt = function LayoutColumn3Alt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0h5v17H0V0zm6 17h5V0H6v17zm6-17v17h5V0h-5z"/></svg>
};
module.exports.LayoutColumn3 = function LayoutColumn3 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 17h5V0H0v17zM1 1h3v15H1V1zm5 16h5V0H6v17zM7 1h3v15H7V1zm5-1v17h5V0h-5zm4 16h-3V1h3v15z"/></svg>
};
module.exports.LayoutColumn4Alt = function LayoutColumn4Alt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M1 0h3v17H1V0zm4 17h3V0H5v17zm4 0h3V0H9v17zm4-17v17h3V0h-3z"/></svg>
};
module.exports.LayoutColumn4 = function LayoutColumn4 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M1 17h3V0H1v17zM2 1h1v15H2V1zm3 16h3V0H5v17zM6 1h1v15H6V1zm3 16h3V0H9v17zm1-16h1v15h-1V1zm3-1v17h3V0h-3zm2 16h-1V1h1v15z"/></svg>
};
module.exports.LayoutCtaBtnLeft = function LayoutCtaBtnLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 7H8V6h7v1zM8.007 9h5V8h-5v1zM17 3v10H0V3h17zm-1 1H1v8h15V4zM7 6H2v2h5V6z"/></svg>
};
module.exports.LayoutCtaBtnRight = function LayoutCtaBtnRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M9 7H2V6h7v1zM3.993 9h5V8h-5v1zM17 3v10H0V3h17zm-1 1H1v8h15V4zm-1 2h-5v2h5V6z"/></svg>
};
module.exports.LayoutCtaCenter = function LayoutCtaCenter (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14 8H3V7h11v1zm3-5v11H0V3h17zm-1 1H1v9h15V4zm-9.643 7h4.286V9H6.357v2z"/></svg>
};
module.exports.LayoutCtaLeft = function LayoutCtaLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 3v11h17V3H0zm16 10H1V4h15v9zm-3-5H3V7h10v1zm-5 3H3V9h5v2z"/></svg>
};
module.exports.LayoutCtaRight = function LayoutCtaRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 3v11h17V3H0zm16 10H1V4h15v9zm-2-5H4V7h10v1zM9 9h5v2H9V9z"/></svg>
};
module.exports.LayoutGrid2Alt = function LayoutGrid2Alt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0h7v7H0V0zm9 0v7h7V0H9zM0 16h7V9H0v7zm9 0h7V9H9v7z"/></svg>
};
module.exports.LayoutGrid2Thumb = function LayoutGrid2Thumb (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 2h3v3H0V2zm9 3h3V2H9v3zm-9 8h3v-3H0v3zm9 0h3v-3H9v3zM4 3h4V2H4v1zm0 2h4V4H4v1zm9-3v1h4V2h-4zm0 3h4V4h-4v1zm-6 .999H4v1h3v-1zm9 0h-3v1h3v-1zM4 11h4v-1H4v1zm0 2h4v-1H4v1zm9-2h4v-1h-4v1zm0 2h4v-1h-4v1zm-9 1.999h3v-1H4v1zm9 0h3v-1h-3v1z"/></svg>
};
module.exports.LayoutGrid2 = function LayoutGrid2 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 7h7V0H0v7zm1-6h5v5H1V1zM9 0v7h7V0H9zm6 6h-5V1h5v5zM0 16h7V9H0v7zm1-6h5v5H1v-5zM9 16h7V9H9v7zm1-6h5v5h-5v-5z"/></svg>
};
module.exports.LayoutGrid3Alt = function LayoutGrid3Alt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0h5v5H0V0zm6 5h5V0H6v5zm6-5v5h5V0h-5zM0 11h5V6H0v5zm6 0h5V6H6v5zm6 0h5V6h-5v5zM0 17h5v-5H0v5zm6 0h5v-5H6v5zm6 0h5v-5h-5v5z"/></svg>
};
module.exports.LayoutGrid3 = function LayoutGrid3 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 5h5V0H0v5zm1-4h3v3H1V1zm5 4h5V0H6v5zm1-4h3v3H7V1zm5-1v5h5V0h-5zm4 4h-3V1h3v3zM0 11h5V6H0v5zm1-4h3v3H1V7zm5 4h5V6H6v5zm1-4h3v3H7V7zm5 4h5V6h-5v5zm1-4h3v3h-3V7zM0 17h5v-5H0v5zm1-4h3v3H1v-3zm5 4h5v-5H6v5zm1-4h3v3H7v-3zm5 4h5v-5h-5v5zm1-4h3v3h-3v-3z"/></svg>
};
module.exports.LayoutGrid4Alt = function LayoutGrid4Alt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M1 1h3v3H1V1zm4 3h3V1H5v3zm4 0h3V1H9v3zm4-3v3h3V1h-3zM1 8h3V5H1v3zm4 0h3V5H5v3zm4 0h3V5H9v3zm4 0h3V5h-3v3zM1 12h3V9H1v3zm4 0h3V9H5v3zm4 0h3V9H9v3zm4 0h3V9h-3v3zM1 16h3v-3H1v3zm4 0h3v-3H5v3zm4 0h3v-3H9v3zm4 0h3v-3h-3v3z"/></svg>
};
module.exports.LayoutGrid4 = function LayoutGrid4 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M1 4h3V1H1v3zm1-2h1v1H2V2zm3 2h3V1H5v3zm1-2h1v1H6V2zm3 2h3V1H9v3zm1-2h1v1h-1V2zm3-1v3h3V1h-3zm2 2h-1V2h1v1zM1 8h3V5H1v3zm1-2h1v1H2V6zm3 2h3V5H5v3zm1-2h1v1H6V6zm3 2h3V5H9v3zm1-2h1v1h-1V6zm3 2h3V5h-3v3zm1-2h1v1h-1V6zM1 12h3V9H1v3zm1-2h1v1H2v-1zm3 2h3V9H5v3zm1-2h1v1H6v-1zm3 2h3V9H9v3zm1-2h1v1h-1v-1zm3 2h3V9h-3v3zm1-2h1v1h-1v-1zM1 16h3v-3H1v3zm1-2h1v1H2v-1zm3 2h3v-3H5v3zm1-2h1v1H6v-1zm3 2h3v-3H9v3zm1-2h1v1h-1v-1zm3 2h3v-3h-3v3zm1-2h1v1h-1v-1z"/></svg>
};
module.exports.LayoutLineSolid = function LayoutLineSolid (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 8v1H0V8h17z"/></svg>
};
module.exports.LayoutListLargeImage = function LayoutListLargeImage (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.497 5H14V4h2.497v1zm-.998 2.996H14v1h1.499v-1zm-1.495-1.998v1H17v-1h-2.996zM14 10.993h2.996v-1H14v1zM14 13h2.497v-1H14v1zM0 4h13v9H0V4zm1 8h11V5H1v7z"/></svg>
};
module.exports.LayoutListPost = function LayoutListPost (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14 5H0V3h14v2zM0 6v1h17V6H0zm14 4H0v2h14v-2zM0 14h17v-1H0v1z"/></svg>
};
module.exports.LayoutListThumbAlt = function LayoutListThumbAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 5H6V4h9v1zM6 6v1h11V6H6zM0 8h5V3H0v5zm15 3H6v1h9v-1zm-9 3h11v-1H6v1zm-6 1h5v-5H0v5z"/></svg>
};
module.exports.LayoutListThumb = function LayoutListThumb (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 4H6V3h9v1zM6 5v1h11V5H6zM0 2h5v5H0V2zm1 4h3V3H1v3zm14 4H6v1h9v-1zm-9 3h11v-1H6v1zM0 9h5v5H0V9zm1 4h3v-3H1v3z"/></svg>
};
module.exports.LayoutMediaCenterAlt = function LayoutMediaCenterAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M1 13h15v1H1v-1zm3 2.993h9v-1H4v1zM17 1v11H0V1h17zm-1 1H1v9h15V2z"/></svg>
};
module.exports.LayoutMediaCenter = function LayoutMediaCenter (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M1 4v6h15V4H1zm14 5H2V5h13v4zm-1 2v1H3v-1h11zM2 13h13v1H2v-1z"/></svg>
};
module.exports.LayoutMediaLeftAlt = function LayoutMediaLeftAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 13h15v1H0v-1zm0 2.993h10v-1H0v1zM17 1v11H0V1h17zm-1 1H1v9h15V2z"/></svg>
};
module.exports.LayoutMediaLeft = function LayoutMediaLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M10 4h5.826v1H10V4zM10 7.996h3.497v1H10v-1zM10.009 5.998H17v1h-6.991v-1zM10 9.993h6.991v1H10v-1zM10 12h5.826v1H10v-1zM0 13h9V4H0v9zm1-8h7v7H1V5z"/></svg>
};
module.exports.LayoutMediaOverlayAlt2 = function LayoutMediaOverlayAlt2 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12 9H2V8h10v1zm0 1H2v1h10v-1zm5-9v15H0V1h17zm-1 1H1v13h15V2z"/></svg>
};
module.exports.LayoutMediaOverlayAlt = function LayoutMediaOverlayAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 2v12h17V2H0zm1 8.01V3h15v7.01H1z"/></svg>
};
module.exports.LayoutMediaOverlay = function LayoutMediaOverlay (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 12H2v-1h13v1zm-3 .993H2v1h10v-1zM17 1v15H0V1h17zm-1 1H1v13h15V2z"/></svg>
};
module.exports.LayoutMediaRightAlt = function LayoutMediaRightAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M2 13h15v1H2v-1zm5 2.993h10v-1H7v1zM17 1v11H0V1h17zm-1 1H1v9h15V2z"/></svg>
};
module.exports.LayoutMediaRight = function LayoutMediaRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8 4v9h9V4H8zm8 8H9V5h7v7zM1.174 4H7v1H1.174V4zm2.329 3.996H7v1H3.503v-1zm3.488-.998H0v-1h6.991v1zM.009 9.993H7v1H.009v-1zM1.174 12H7v1H1.174v-1z"/></svg>
};
module.exports.LayoutMenuFull = function LayoutMenuFull (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 7v3h17V7H0zm9 1h3v1H9V8zM8 9H5V8h3v1zM1 8h3v1H1V8zm15 1h-3V8h3v1z"/></svg>
};
module.exports.LayoutMenuSeparated = function LayoutMenuSeparated (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 10h5V7H0v3zm1-2h3v1H1V8zm5 2h5V7H6v3zm1-2h3v1H7V8zm5-1v3h5V7h-5zm4 2h-3V8h3v1z"/></svg>
};
module.exports.LayoutMenuV = function LayoutMenuV (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M3 1v3h11V1H3zm10 2H4V2h9v1zM3 8h11V5H3v3zm1-2h9v1H4V6zm-1 5.997h11v-3H3v3zm1-2h9v1H4v-1zm-1 6h11v-3H3v3zm1-2h9v1H4v-1z"/></svg>
};
module.exports.LayoutMenu = function LayoutMenu (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 7v3h13V7H0zm8 1v1H5V8h3zM1 8h3v1H1V8zm11 1H9V8h3v1z"/></svg>
};
module.exports.LayoutPlaceholder = function LayoutPlaceholder (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M.021 1.012v15h17v-15h-17zm8.116 7.497-7.116 6.197V2.294l7.116 6.215zM1.459 2.012h14.138L8.518 8.177 1.459 2.012zm7.058 6.829 7.066 6.171H1.431l7.086-6.171zm.381-.332 7.123-6.204V14.73L8.898 8.509z"/></svg>
};
module.exports.LayoutSidebar2 = function LayoutSidebar2 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 0v17h-4V0h4zM0 17h3V0H0v17zm11 0h1v-1h-1v1zm-3.429 0h.857v-1h-.857v1zm1.715 0h.857v-1h-.857v1zm-3.429 0h.857v-1h-.857v1zM4 17h1v-1H4v1zM4 3h1V2H4v1zm0 10h1v-1H4v1zm0 2h1v-1H4v1zm0-4h1v-1H4v1zm0-4h1V6H4v1zm0-2h1V4H4v1zm0 4h1V8H4v1zm0-8h1V0H4v1zm1.857 0h.857V0h-.857v1zm3.429 0h.857V0h-.857v1zM7.571 1h.857V0h-.857v1zM11 1h1V0h-1v1zm0 4h1V4h-1v1zm0-2h1V2h-1v1zm0 4h1V6h-1v1zm0 2h1V8h-1v1zm0 6h1v-1h-1v1zm0-2h1v-1h-1v1zm0-2h1v-1h-1v1z"/></svg>
};
module.exports.LayoutSidebarLeft = function LayoutSidebarLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0h5v17H0V0zm7 17h1v-1H7v1zm7.222 0h.889v-1h-.889v1zm-1.778 0h.889v-1h-.889v1zm-3.555 0h.889v-1h-.889v1zm1.778 0h.889v-1h-.889v1zM16 17h1v-1h-1v1zm0-14h1V2h-1v1zm0 12h1v-1h-1v1zm0-8h1V6h-1v1zm0-2h1V4h-1v1zm0 4h1V8h-1v1zm0 2h1v-1h-1v1zm0 2h1v-1h-1v1zm0-13v1h1V0h-1zm-1.777 1h.889V0h-.889v1zm-1.778 0h.889V0h-.889v1zm-1.778 0h.889V0h-.889v1zM8.889 1h.889V0h-.889v1zM7 1h1V0H7v1zm0 14h1v-1H7v1zm0-2h1v-1H7v1zm0-6h1V6H7v1zm0 4h1v-1H7v1zm0-6h1V4H7v1zm0-2h1V2H7v1zm0 6h1V8H7v1z"/></svg>
};
module.exports.LayoutSidebarNone = function LayoutSidebarNone (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 16h1v1H0v-1zm14 1h1v-1h-1v1zm-2 0h1v-1h-1v1zm-2 0h1v-1h-1v1zm-2 0h1v-1H8v1zm-2 0h1v-1H6v1zm-4 0h1v-1H2v1zm2 0h1v-1H4v1zm12 0h1v-1h-1v1zm0-6h1v-1h-1v1zm0 2h1v-1h-1v1zm0-8h1V4h-1v1zm0 4h1V8h-1v1zm0-2h1V6h-1v1zm0-4h1V2h-1v1zm0 12h1v-1h-1v1zm0-15v1h1V0h-1zM4 1h1V0H4v1zM2 1h1V0H2v1zm10 0h1V0h-1v1zm-2 0h1V0h-1v1zM6 1h1V0H6v1zm8 0h1V0h-1v1zM8 1h1V0H8v1zM0 1h1V0H0v1zm0 12h1v-1H0v1zm0 2h1v-1H0v1zm0-4h1v-1H0v1zm0-6h1V4H0v1zm0 4h1V8H0v1zm0-6h1V2H0v1zm0 4h1V6H0v1z"/></svg>
};
...
module.exports.LayoutSliderAlt = function LayoutSliderAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M2 14h13V3H2v11zM3 4h11v9H3V4zM16 4.531h1v7.938h-1V4.531zM0 4.531h1v7.938H0V4.531z"/></svg>
};
module.exports.LayoutSlider = function LayoutSlider (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 1v14h17V1H0zm16 13H1V2h15v12zM4.646 10.354 2.293 8l2.354-2.354.707.707L3.707 8l1.646 1.646-.707.708zm7-.708L13.293 8l-1.646-1.646.707-.707L14.707 8l-2.354 2.354-.707-.708z"/></svg>
};
module.exports.LayoutTabMin = function LayoutTabMin (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M7 2V1H0v3.997h1V2h5v3h11V2H7zm0 1h4v1H7V3zm5 1V3h4v1h-4z"/></svg>
};
module.exports.LayoutTabV = function LayoutTabV (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M6 1v1H0v4h1v4h5v6.018h11V1H6zM2 6h4v1H2V6zm0 3V8h4v1H2zm14 6.018H7V5H1V3h6V2h9v13.018z"/></svg>
};
module.exports.LayoutTabWindow = function LayoutTabWindow (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12 2H0v14h17V2h-5zm4 1v2h-4V3h4zm-5 0v2H6V3h5zM1 3h4v2H1V3zm15 12H1V6h15v9z"/></svg>
};
module.exports.LayoutTab = function LayoutTab (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M7 3V2H0v14h17V3H7zm4 1v1H7V4h4zm5 11H1V3h5v3h10v9zM12 5V4h4v1h-4z"/></svg>
};
module.exports.LayoutWidthDefaultAlt = function LayoutWidthDefaultAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M2 16h1v1H2v-1zm8 1h1v-1h-1v1zm2 0h1v-1h-1v1zm-8 0h1v-1H4v1zm2 0h1v-1H6v1zm2 0h1v-1H8v1zm6 0h1v-1h-1v1zm0-14h1V2h-1v1zm0 2h1V4h-1v1zm0 8h1v-1h-1v1zm0-6h1V6h-1v1zm0 2h1V8h-1v1zm0 6h1v-1h-1v1zm0-4h1v-1h-1v1zm0-11v1h1V0h-1zm-2 1h1V0h-1v1zM6 1h1V0H6v1zm2 0h1V0H8v1zm2 0h1V0h-1v1zM4 1h1V0H4v1zM2 1h1V0H2v1zm0 12h1v-1H2v1zm0 2h1v-1H2v1zm0-4h1v-1H2v1zm0-8h1V2H2v1zm0 2h1V4H2v1zm0 2h1V6H2v1zm0 2h1V8H2v1z"/></svg>
};
module.exports.LayoutWidthDefault = function LayoutWidthDefault (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0v17h17V0H0zm16 16H1V1h15v15zM3 8h1v1H3V8zm0-4h1v1H3V4zm0 6h1v1H3v-1zm0-4h1v1H3V6zm0-4h1v1H3V2zm0 12h1v1H3v-1zm0-2h1v1H3v-1zM13 2h1v1h-1V2zm0 4h1v1h-1V6zm0-2h1v1h-1V4zm0 4h1v1h-1V8zm0 2h1v1h-1v-1zm0 2h1v1h-1v-1zm0 2h1v1h-1v-1z"/></svg>
};
module.exports.LayoutWidthFull = function LayoutWidthFull (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0v17h17V0H0zm16 16H1V1h15v15z"/></svg>
};
module.exports.Layout = function Layout (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0v17h17V0H0zm1 6h9v10H1V6zm15 10h-5V6h5v10zM1 5V1h15v4H1z"/></svg>
};
module.exports.LightBulb = function LightBulb (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5 0C5.468 0 3 2.617 3 5.833c0 2.354.964 3.67 1.814 4.831C5.451 11.532 6 12.282 6 13.337v2.096C6 16.297 6.673 17 7.5 17h2c.827 0 1.5-.703 1.5-1.567v-2.126c0-1.045.517-1.735 1.17-2.609C12.985 9.607 14 8.251 14 5.833 14 2.617 11.532 0 8.5 0zm1 16h-2c-.275 0-.5-.254-.5-.567V13.8h3v1.633c0 .313-.225.567-.5.567zm1.869-5.901c-.587.785-1.19 1.593-1.336 2.701H6.961c-.152-1.102-.754-1.927-1.34-2.727C4.824 8.985 4 7.86 4 5.833 4 3.168 6.019 1 8.5 1S13 3.168 13 5.833c0 2.085-.829 3.194-1.631 4.266z"/></svg>
};
module.exports.LineDashed = function LineDashed (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 8h4v1H0V8zm6.5 1h4V8h-4v1zM13 8v1h4V8h-4z"/></svg>
};
module.exports.LineDotted = function LineDotted (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 7.998h.5v1H0v-1zm2.383 1.001h.941v-1h-.941v1zm2.823 0h.941v-1h-.941v1zM10.854 9h.941V8h-.941v1zM8.03 8.999h.94V8h-.94v.999zM13.677 9h.941V8h-.941v1zM16.5 8v1h.5V8h-.5z"/></svg>
};
module.exports.LineDouble = function LineDouble (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 6v1H0V6h17zM0 10h17V9H0v1z"/></svg>
};
module.exports.Link = function Link (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m12.983 6.94-.938.938-.707-.707.938-.938c.975-.975.975-2.561 0-3.535s-2.561-.975-3.535 0L5.754 5.686c-.975.975-.975 2.561 0 3.535s2.561.975 3.535 0l.707.707c-.683.683-1.578 1.023-2.475 1.023s-1.792-.341-2.474-1.023a3.504 3.504 0 0 1 0-4.949l2.987-2.987a3.502 3.502 0 0 1 4.949 0 3.501 3.501 0 0 1 0 4.948zM6.042 8.034l-.13.129.705.709.131-.13c.975-.975 2.561-.975 3.535 0s.975 2.561 0 3.535L7.26 15.302c-.975.975-2.561.975-3.535 0s-.975-2.561 0-3.535l1.058-1.059-.707-.707-1.058 1.059a3.504 3.504 0 0 0 0 4.949c.683.683 1.578 1.023 2.475 1.023s1.792-.341 2.475-1.023l3.023-3.024a3.504 3.504 0 0 0 0-4.949 3.503 3.503 0 0 0-4.949-.002z"/></svg>
};
...
module.exports.Medall = function Medall (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5 0c-2.757 0-5 2.243-5 5 0 1.375.555 2.659 1.562 3.616.085.082.18.154.276.226l.103.078c.179.141.369.257.559.371V16.5l2.479-1.901L11 16.5V9.291c.19-.114.381-.231.56-.372l.103-.077c.096-.072.19-.144.276-.226A4.951 4.951 0 0 0 13.5 5c0-2.757-2.243-5-5-5zM10 14.493l-1.526-1.151L7 14.473v-4.225a4.568 4.568 0 0 0 3 0v4.245zm1.249-6.601c-.057.055-.121.101-.185.147l-.123.094a3.927 3.927 0 0 1-4.881.001l-.124-.095c-.064-.047-.128-.093-.185-.147A3.957 3.957 0 0 1 4.5 5c0-2.206 1.794-4 4-4s4 1.794 4 4a3.957 3.957 0 0 1-1.251 2.892zm-.299-4.378.184.982-1.823.341 1.146 1.937-.861.51-1.087-1.836-1.09 1.835-.859-.51 1.152-1.94-1.776-.337.186-.982L8 3.869V2h1v1.878l1.95-.364z"/></svg>
};
module.exports.MenuAlt = function MenuAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16 2v2H5V2h11zM5 9h11V7H5v2zm0 5h11v-2H5v2zM2 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/></svg>
};
module.exports.Menu = function Menu (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16 3v2H1V3h15zM1 10h15V8H1v2zm0 5h15v-2H1v2z"/></svg>
};
module.exports.MicrophoneAlt = function MicrophoneAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M11.614 7.021a4.21 4.21 0 0 0 1.12-2.847c0-2.335-1.899-4.234-4.234-4.234S4.266 1.839 4.266 4.174c0 1.1.432 2.093 1.12 2.847L6.523 15H8v1.984h1V15h1.477l1.137-7.979zM6 2.147V4h1V1.326c.309-.164.643-.28 1-.336V5h1V.99c.357.056.691.172 1 .336V4h1V2.147c.452.557.734 1.256.734 2.026 0 1.784-1.451 3.235-3.234 3.235s-3.234-1.45-3.234-3.234c0-.771.282-1.47.734-2.027zM7.391 14l-.87-6.104c.593.316 1.26.513 1.979.513s1.386-.197 1.979-.514L9.609 14H7.391z"/></svg>
};
module.exports.Microphone = function Microphone (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5 12c2.481 0 4.5-2.019 4.5-4.5v-3C13 2.189 11.244.303 9 .051V0H8v.051C5.756.303 4 2.189 4 4.5v3C4 9.981 6.019 12 8.5 12zM6 2.059V4h1V1.352a3.45 3.45 0 0 1 1-.301V4h1V1.051a3.42 3.42 0 0 1 1 .301V4h1V2.059c.617.631 1 1.491 1 2.441V5H5v-.5c0-.95.383-1.811 1-2.441zM5 6h7v1.5c0 1.93-1.57 3.5-3.5 3.5S5 9.43 5 7.5V6zm10 1v3.25c0 2.067-2.019 3.75-4.5 3.75H9v3H8v-3H6.5C4.019 14 2 12.317 2 10.25V7h1v3.25C3 11.767 4.57 13 6.5 13h4c1.93 0 3.5-1.233 3.5-2.75V7h1z"/></svg>
};
module.exports.MicrosoftAlt = function MicrosoftAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m0 2.339 6.967-.959v6.732H0V2.339zm0 12.322 6.967.959V8.97H0v5.691zM7.734 1.277v6.835H17V0L7.734 1.277zm0 14.446L17 17V8.97H7.734v6.753z"/></svg>
};
module.exports.Microsoft = function Microsoft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M7.734 15.723 17 17V8.97H7.734v6.753zm1-5.753H16v5.883l-7.266-1.002V9.97zM0 14.661l6.967.959V8.97H0v5.691zM1 9.97h4.967v4.503L1 13.789V9.97zM0 8.112h6.967V1.38L0 2.339v5.773zM1 3.21l4.967-.684v4.585H1V3.21zm6.734-1.933v6.835H17V0L7.734 1.277zM16 7.112H8.734V2.149L16 1.147v5.965z"/></svg>
};
module.exports.Minus = function Minus (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 8v1H2V8h13z"/></svg>
};
module.exports.Mobile = function Mobile (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12.5 0h-8C3.673 0 3 .673 3 1.5v14c0 .827.673 1.5 1.5 1.5h8c.827 0 1.5-.673 1.5-1.5v-14c0-.827-.673-1.5-1.5-1.5zm-8 1h8a.5.5 0 0 1 .5.5V3H4V1.5a.5.5 0 0 1 .5-.5zM13 4v8H4V4h9zm-.5 12h-8a.5.5 0 0 1-.5-.5V13h9v2.5a.5.5 0 0 1-.5.5zM9 14.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"/></svg>
};
module.exports.Money = function Money (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m10.719 9.577-.01-.01c-.013-.011-.022-.024-.036-.034l-.003.004L9 8.255V2.548c1.14.218 2 1.164 2 2.296l.499.06.501-.06c0-1.68-1.309-3.062-3-3.296V0H8v1.548c-1.691.234-3 1.616-3 3.296 0 .942.421 1.838 1.151 2.473l-.005.005.04.031L8 8.747v5.705c-1.14-.218-2-1.164-2-2.296H5c0 1.68 1.309 3.062 3 3.296v1.549h1v-1.549c1.691-.234 3-1.616 3-3.296 0-1.006-.469-1.939-1.281-2.579zM6.822 6.581A2.29 2.29 0 0 1 6 4.844c0-1.132.86-2.078 2-2.296v4.938l-1.178-.905zM9 14.452V9.516l1.104.849c.567.447.896 1.096.896 1.791 0 1.132-.86 2.078-2 2.296z"/></svg>
};
module.exports.MoreAlt = function MoreAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M4 8a2 2 0 1 1-4.001-.001A2 2 0 0 1 4 8zm4.5-2a2 2 0 1 0 .001 4.001A2 2 0 0 0 8.5 6zM15 6a2 2 0 1 0 .001 4.001A2 2 0 0 0 15 6z"/></svg>
};
module.exports.More = function More (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M2 6a2 2 0 1 0 .001 4.001A2 2 0 0 0 2 6zm0 3a1.001 1.001 0 0 1 0-2 1.001 1.001 0 0 1 0 2zm6.5-3a2 2 0 1 0 .001 4.001A2 2 0 0 0 8.5 6zm0 3a1.001 1.001 0 0 1 0-2 1.001 1.001 0 0 1 0 2zM15 6a2 2 0 1 0 .001 4.001A2 2 0 0 0 15 6zm0 3a1.001 1.001 0 0 1 0-2 1.001 1.001 0 0 1 0 2z"/></svg>
};
module.exports.MouseAlt = function MouseAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5 0A5.506 5.506 0 0 0 3 5.5v6C3 14.533 5.467 17 8.5 17s5.5-2.467 5.5-5.5v-6C14 2.467 11.533 0 8.5 0zM13 5.5V6H9V1.051c2.244.252 4 2.139 4 4.449zM8 1.051V6H4v-.5c0-2.31 1.756-4.197 4-4.449zM8.5 16A4.505 4.505 0 0 1 4 11.5V7h9v4.5c0 2.481-2.019 4.5-4.5 4.5z"/></svg>
};
...
module.exports.Music = function Music (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m14.765 4.459.421-.906L8 .217v9.878a2.885 2.885 0 0 0-1.898-.722c-1.607 0-2.914 1.308-2.914 2.914s1.307 2.914 2.914 2.914 2.914-1.308 2.914-2.914c0-.053-.013-.103-.016-.154V1.783l5.765 2.676zm-8.663 9.742c-1.056 0-1.914-.858-1.914-1.914s.858-1.914 1.914-1.914 1.914.858 1.914 1.914-.859 1.914-1.914 1.914z"/></svg>
};
module.exports.Na = function Na (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5.5c-4.411 0-8 3.589-8 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm0 1c1.75 0 3.348.65 4.577 1.716l-9.86 9.861A6.957 6.957 0 0 1 1.5 8.5c0-3.859 3.14-7 7-7zm0 14c-1.75 0-3.348-.65-4.577-1.716l9.86-9.861A6.957 6.957 0 0 1 15.5 8.5c0 3.859-3.14 7-7 7z"/></svg>
};
module.exports.NewWindow = function NewWindow (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 2v7.5h-1V3.832l-9.334 9.334-.707-.707L13.418 3H7.5V2H15zm-4 14H1V6h6.574V5H0v12h12V9.286h-1V16z"/></svg>
};
module.exports.Notepad = function Notepad (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M1 0v17h15V0H1zm14 16H2V1h2v1.092c-.581.207-1 .757-1 1.408C3 4.327 3.673 5 4.5 5S6 4.327 6 3.5c0-.651-.419-1.201-1-1.408V1h3v1.092c-.581.207-1 .757-1 1.408C7 4.327 7.673 5 8.5 5S10 4.327 10 3.5c0-.651-.419-1.201-1-1.408V1h3v1.092c-.581.207-1 .757-1 1.408 0 .827.673 1.5 1.5 1.5S14 4.327 14 3.5c0-.651-.419-1.201-1-1.408V1h2v15zM5 3.5c0 .275-.225.5-.5.5S4 3.775 4 3.5s.225-.5.5-.5.5.225.5.5zm4 0c0 .275-.225.5-.5.5S8 3.775 8 3.5s.225-.5.5-.5.5.225.5.5zm4 0c0 .275-.225.5-.5.5s-.5-.225-.5-.5.225-.5.5-.5.5.225.5.5z"/></svg>
};
module.exports.Package = function Package (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.517-.035 0 3.186v10.693l8.5 3.188 8.5-3.188V3.187L8.517-.035zm6.567 3.563-2.586.97-6.557-2.489 2.575-.974 6.568 2.493zM8.5 5.997 1.919 3.529l2.609-.986 6.551 2.487-2.579.967zM1 4.253l7 2.625v8.932l-7-2.625V4.253zM9 15.81V6.878l7-2.625v8.932L9 15.81z"/></svg>
};
module.exports.PaintBucket = function PaintBucket (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.701 9.818 7.833.894l-.134.133A3.527 3.527 0 0 0 5.206 0h-.001c-.948 0-1.841.37-2.512 1.041a3.528 3.528 0 0 0-1.042 2.514c0 .941.366 1.825 1.027 2.493L.47 8.257C.167 8.561 0 8.963 0 9.39c0 .429.166.83.467 1.13l4.811 4.859a1.59 1.59 0 0 0 1.131.469 1.59 1.59 0 0 0 1.133-.471L13.1 9.819l3.601-.001zM2.651 3.554c0-.682.266-1.323.749-1.806A2.538 2.538 0 0 1 5.205 1h.001c.674 0 1.306.262 1.786.734L3.386 5.341a2.532 2.532 0 0 1-.735-1.787zm4.182 11.117a.6.6 0 0 1-.847.003L2.35 11h8.154l-3.671 3.671zM11.504 10H1.359l-.183-.186a.602.602 0 0 1 .001-.85L7.831 2.31l6.468 6.509-1.614.001L11.504 10zm4.184 1.959-.407-.604-.418.598c-.319.457-1.363 2.011-1.363 2.798 0 .965.785 1.75 1.75 1.75S17 15.715 17 14.75c0-.782-1.004-2.334-1.312-2.791zM15.25 15.5a.752.752 0 0 1-.75-.75c0-.24.349-.92.766-1.591.4.67.734 1.349.734 1.591 0 .413-.337.75-.75.75z"/></svg>
};
module.exports.PaintRoller = function PaintRoller (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 2V0H2v2h-.516C.666 2 0 2.675 0 3.505v2.99C0 7.325.666 8 1.484 8h6.024c.275 0 .5.225.5.5V10H7v7h3v-7h-.992V8.5c0-.827-.673-1.5-1.5-1.5H1.484A.496.496 0 0 1 1 6.495v-2.99C1 3.227 1.218 3 1.484 3H2v3h13V3h1V2h-1zM9 16H8v-5h1v5zm5-11H3V1h11v4z"/></svg>
};
module.exports.Palette = function Palette (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5.5c-4.411 0-8 3.589-8 8a7.98 7.98 0 0 0 7.631 7.982l1.288.059-2.723-2.723c-.283-.283-.439-.66-.439-1.061s.156-.777.439-1.061c.566-.566 1.555-.566 2.121 0l3.719 3.719.34-.223A7.977 7.977 0 0 0 16.5 8.5c0-4.411-3.589-8-8-8zm4.16 13.625L9.525 10.99c-.943-.944-2.592-.944-3.535 0-.472.472-.732 1.1-.732 1.768s.26 1.296.732 1.768l.741.741A6.982 6.982 0 0 1 1.5 8.5c0-3.86 3.14-7 7-7s7 3.14 7 7a6.979 6.979 0 0 1-2.84 5.625zM11.5 6.5c-1.103 0-2 .897-2 2s.897 2 2 2 2-.897 2-2-.897-2-2-2zm0 3c-.551 0-1-.449-1-1s.449-1 1-1 1 .449 1 1-.449 1-1 1zM8.5 6a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm-2.75-.109a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/></svg>
};
module.exports.Panel = function Panel (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0v17h17V0H0zm16 16H1V1h15v15zM4 10.232V13h1v-2.768c.738-.218 1.281-.894 1.281-1.701S5.738 7.048 5 6.83V4H4v2.83c-.738.218-1.281.894-1.281 1.701S3.262 10.015 4 10.232zm.5-2.482a.782.782 0 0 1 0 1.562.781.781 0 0 1 0-1.562zm3.5.357V13h1V8.107c.738-.218 1.281-.894 1.281-1.701S9.738 4.923 9 4.705V4H8v.705c-.738.218-1.281.894-1.281 1.701S7.262 7.89 8 8.107zm.5-2.482a.782.782 0 1 1-.002 1.564.782.782 0 0 1 .002-1.564zm4 7.792c.982 0 1.781-.799 1.781-1.781 0-.808-.543-1.483-1.281-1.701V4h-1v5.935a1.778 1.778 0 0 0-1.281 1.701c0 .982.799 1.781 1.781 1.781zm0-2.563a.782.782 0 0 1 0 1.562.782.782 0 0 1 0-1.562z"/></svg>
};
module.exports.Paragraph = function Paragraph (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16 1.026H4.992c-2.181 0-3.955 1.774-3.955 3.955s1.774 3.954 3.955 3.954H8V16h1V2.026h2.015V16h1V2.026H16v-1zm-8 6.91H4.992a2.957 2.957 0 0 1-2.955-2.954 2.958 2.958 0 0 1 2.955-2.955H8v5.909z"/></svg>
};
module.exports.PencilAlt = function PencilAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.499 1.843 15.096.44c-.566-.566-1.555-.566-2.122 0L5.438 7.976l-1.722 5.287 5.249-1.765 7.534-7.534c.283-.283.439-.66.439-1.061s-.156-.777-.439-1.06zM5.584 10.758l.638-1.957 1.92 1.919-1.942.653-.616-.615zm1.248-2.762 3.986-3.986 2.11 2.11-3.986 3.986-2.11-2.11zm4.693-4.693.729-.729 2.11 2.11-.729.729-2.11-2.11zm4.267-.046-.72.721-2.11-2.11.72-.721a.512.512 0 0 1 .707 0l1.403 1.403a.5.5 0 0 1 0 .707zM15 7.5h1V17H0V2h7.5v1H1v13h14V7.5z"/></svg>
};
module.exports.PencilAlt2 = function PencilAlt2 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M9.492 0H7.508c-.827 0-1.5.673-1.5 1.5v10.657l2.521 4.956 2.464-4.959V1.5A1.503 1.503 0 0 0 9.492 0zM7.508 1h1.984c.275 0 .5.225.5.5v1.019H7.008V1.5a.5.5 0 0 1 .5-.5zm.57 13.021-.934-1.835h2.715l-.911 1.835h-.87zm-1.07-2.834V5.55h2.984v5.637H7.008zm0-6.637V3.519h2.984V4.55H7.008z"/></svg>
};
module.exports.Pencil = function Pencil (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m15.529 2.857-1.403-1.404c-.565-.566-1.555-.566-2.122 0l-9.057 9.058-1.722 5.288 5.248-1.765 9.055-9.056a1.5 1.5 0 0 0 .001-2.121zM3.094 13.294l.645-1.979 1.934 1.935-1.963.66-.616-.616zm1.261-2.776 5.493-5.493 2.111 2.11-5.494 5.494-2.11-2.111zm6.2-6.201.729-.729 2.111 2.11-.729.729-2.111-2.11zm4.267-.046-.72.72-2.111-2.11.72-.721a.512.512 0 0 1 .707 0l1.403 1.404a.5.5 0 0 1 .001.707z"/></svg>
};
module.exports.PieChart = function PieChart (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m14.985 8.943.998.067C15.72 12.93 12.433 16 8.5 16 4.364 16 1 12.636 1 8.5c0-3.905 3.047-7.19 6.938-7.479l.074.997C4.641 2.268 2 5.115 2 8.5 2 12.084 4.916 15 8.5 15c3.409 0 6.257-2.66 6.485-6.057zM17 7.499v.5l-.501.017H9.017V-.001L9.518 0C13.644.009 17 3.374 17 7.499zm-1.014-.483c-.223-3.17-2.776-5.743-5.969-5.995v5.995h5.969z"/></svg>
};
module.exports.PinAlt = function PinAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m5.404 10.889.707.707-5.258 5.257-.707-.707 5.258-5.257zM17 6.222l-2.192.637-3.682 5.246.429 1.118L10 14.778 2.222 7l1.556-1.556 1.118.429 5.245-3.682.248-.854L10.777 0 17 6.222zm-1.902-.488-3.832-3.831-.164.567-.098.338-5.97 4.19-1.009-.387L3.636 7 10 13.364l.389-.39-.195-.512-.191-.497.307-.436 3.883-5.534.338-.098.567-.163z"/></svg>
};
module.exports.Pin = function Pin (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12 4.5C12 2.57 10.43 1 8.5 1S5 2.57 5 4.5a3.495 3.495 0 0 0 2.962 3.445V16h1V7.953C10.672 7.725 12 6.271 12 4.5zM8.5 7C7.121 7 6 5.879 6 4.5S7.121 2 8.5 2 11 3.121 11 4.5 9.879 7 8.5 7zM10 5H9a1 1 0 0 0-1-1V3c1.103 0 2 .897 2 2z"/></svg>
};
module.exports.Pin2 = function Pin2 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8 11.5h1V17H8v-5.5zm6-2.7V11H3V8.8l1.094-.487L5.2 2l-.429-.779L4.1 0h8.8l-.672 1.221L11.8 2l1.106 6.312L14 8.8zm-1 .649-.986-.44-.092-.524-1.168-6.659.17-.309.285-.517H5.791l.455.827-.06.346-1.2 6.836-.986.44V10h9v-.551z"/></svg>
};
module.exports.PinterestAlt = function PinterestAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5.5a8 8 0 0 0-3.211 15.327c-.022-.559-.005-1.229.139-1.837l1.029-4.359s-.256-.511-.256-1.266c0-1.186.688-2.07 1.544-2.07.728 0 1.079.546 1.079 1.2 0 .731-.467 1.826-.707 2.839-.2.849.426 1.541 1.263 1.541 1.516 0 2.537-1.946 2.537-4.253 0-1.753-1.182-3.066-3.329-3.066-2.427 0-3.938 1.811-3.938 3.831 0 .698.205 1.189.527 1.569.147.175.168.246.115.446l-.163.642c-.054.203-.218.275-.4.201C3.61 10.788 3.09 9.564 3.09 8.188c0-2.272 1.916-4.998 5.718-4.998 3.054 0 5.064 2.211 5.064 4.583 0 3.139-1.745 5.483-4.316 5.483-.864 0-1.677-.468-1.955-.998 0 0-.464 1.844-.562 2.199-.17.617-.502 1.233-.806 1.714A8 8 0 0 0 16.5 8.5a8 8 0 0 0-8-8z"/></svg>
};
module.exports.Pinterest = function Pinterest (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.025 6.225c0 3.819-2.123 6.662-5.246 6.662-1.049 0-2.035-.568-2.365-1.213a366.659 366.659 0 0 1-.682 2.667c-.203.746-.619 1.493-.985 2.074-1.043.737-1.14-.404-1.14-.404-.024-.684-.012-1.505.166-2.237 0 0 .189-.785 1.25-5.285-.315-.62-.315-1.543-.315-1.543 0-1.441.835-2.516 1.872-2.516.885 0 1.314.67 1.314 1.467 0 .885-.57 2.213-.859 3.439-.24 1.037.518 1.871 1.529 1.871 1.847 0 3.084-2.363 3.084-5.158 0-2.137-1.44-3.729-4.045-3.729-2.945 0-4.778 2.2-4.778 4.652 0 .848.252 1.442.644 1.91.178.215.203.29.139.543-.049.177-.15.607-.201.771-.063.253-.266.341-.48.253C2.574 9.891 1.941 8.4 1.941 6.731c0-2.756 2.325-6.068 6.928-6.068 3.717 0 6.156 2.692 6.156 5.562z"/></svg>
};
module.exports.Plug = function Plug (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M3 4v5.014C3 11.763 5.468 14 8.5 14S14 11.763 14 9.014V4H3zm10 5.014C13 11.212 10.981 13 8.5 13S4 11.212 4 9.014V5h9v4.014zM7.016 3h-1V0h1v3zm3.968 0h-1V0h1v3zM8 14h1v3H8v-3zm3-6H6V7h5v1zm0 2H6V9h5v1z"/></svg>
};
module.exports.Plus = function Plus (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16 9H9v7H8V9H1V8h7V1h1v7h7v1z"/></svg>
};
module.exports.PowerOff = function PowerOff (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16 9.5c0 4.136-3.364 7.5-7.5 7.5S1 13.636 1 9.5c0-3.498 2.476-6.579 5.888-7.326l.214.977C4.146 3.798 2 6.468 2 9.5 2 13.084 4.916 16 8.5 16S15 13.084 15 9.5c0-3.028-2.143-5.698-5.096-6.348l.215-.977C13.527 2.926 16 6.006 16 9.5zM9 0H8v10h1V0z"/></svg>
};
module.exports.Printer = function Printer (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 6h-3.008V4.182L9.489 0H2.992v6H0v8h3v3.1h11V14h3V6zM9.992 1.832 12.327 4H9.992V1.832zm-6-.832h5v4h4v1h-9V1zM13 16.1H4v-5h9v5zm3-3.1h-2v-2.9H3V13H1V7h15v6zm-4.994 0H5v-1h6.006v1zM9 15H5v-1h4v1zM3 9H2V8h1v1zm2 0H4V8h1v1z"/></svg>
};
module.exports.Pulse = function Pulse (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m14.33 8-1.876-4.377-3.438 9.783L5.001.296 2.631 8H0v1h3.369l1.63-5.296 3.95 12.903 3.597-10.23L13.67 9H17V8z"/></svg>
};
module.exports.QuoteLeft = function QuoteLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M13.169 7.614a3.51 3.51 0 0 0-1.982.612c1.23-3.472 3.991-3.88 4.134-3.898l-.123-.992c-.051.006-5.126.704-5.563 7.725l.015.001c0 .027-.008.054-.008.081 0 1.945 1.583 3.528 3.528 3.528s3.528-1.583 3.528-3.528-1.584-3.529-3.529-3.529zm0 6.057c-1.395 0-2.528-1.134-2.528-2.528s1.134-2.528 2.528-2.528 2.528 1.134 2.528 2.528-1.134 2.528-2.528 2.528zM3.733 7.614c-.734 0-1.416.227-1.981.612 1.23-3.472 3.99-3.88 4.133-3.898l-.123-.992c-.051.006-5.125.704-5.564 7.725l.015.001c0 .027-.008.054-.008.081 0 1.945 1.583 3.528 3.528 3.528s3.528-1.583 3.528-3.528-1.582-3.529-3.528-3.529zm0 6.057c-1.395 0-2.528-1.134-2.528-2.528s1.134-2.528 2.528-2.528 2.528 1.134 2.528 2.528-1.133 2.528-2.528 2.528z"/></svg>
};
module.exports.QuoteRight = function QuoteRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M7.307 6.862a3.533 3.533 0 0 0-3.529-3.529A3.533 3.533 0 0 0 .25 6.862a3.532 3.532 0 0 0 3.528 3.528c.734 0 1.416-.227 1.981-.611-1.231 3.47-3.99 3.877-4.133 3.896l.123.992c.051-.006 5.125-.703 5.563-7.724l-.013-.001c.001-.027.008-.052.008-.08zM3.778 9.391c-1.394 0-2.528-1.134-2.528-2.528s1.134-2.529 2.528-2.529c1.395 0 2.529 1.135 2.529 2.529S5.173 9.391 3.778 9.391zm12.956-2.449c.001-.027.008-.053.008-.08 0-1.946-1.583-3.529-3.528-3.529S9.686 4.916 9.686 6.862a3.532 3.532 0 0 0 3.528 3.528c.734 0 1.416-.227 1.981-.611-1.23 3.47-3.99 3.877-4.133 3.896l.123.992c.051-.006 5.125-.703 5.563-7.724l-.014-.001zm-3.52 2.449c-1.394 0-2.528-1.134-2.528-2.528s1.134-2.529 2.528-2.529 2.528 1.135 2.528 2.529-1.134 2.528-2.528 2.528z"/></svg>
};
module.exports.Receipt = function Receipt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M2 0v16.902l2.028-2.481 1.503 1.88 1.501-1.875 1.499 1.875 1.5-1.875 1.5 1.875 1.499-1.875 1.97 2.46V0H2zm12 14.036-.97-1.211-1.499 1.875-1.5-1.875-1.5 1.875-1.499-1.875L5.531 14.7l-1.495-1.87L3 14.098V1h11v13.036zM10.997 4h-6V3h6v1zm-2 4h-4V7h4v1zm2.981-2h-7V5h7v1zM5 10h7v1H5v-1z"/></svg>
};
module.exports.Reddit = function Reddit (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.581 9.936c.024.161.04.33.04.491 0 1.308-.766 2.517-2.145 3.42-1.347.879-3.121 1.363-5.008 1.363s-3.669-.484-5.008-1.363c-1.388-.903-2.145-2.112-2.145-3.42 0-.177.016-.354.04-.532A1.834 1.834 0 0 1 .5 8.354a1.821 1.821 0 0 1 3.016-1.378c1.291-.823 2.976-1.291 4.774-1.324l1.081-3.41a.32.32 0 0 1 .371-.21l2.799.661a1.503 1.503 0 0 1 2.879.598c0 .83-.669 1.508-1.5 1.508-.823 0-1.492-.67-1.5-1.492L9.879 2.71l-.935 2.951c1.701.072 3.29.541 4.516 1.339a1.821 1.821 0 1 1 2.121 2.936zM1.532 9.25c.258-.693.75-1.339 1.451-1.896a1.168 1.168 0 0 0-.661-.201c-.661 0-1.201.54-1.201 1.201 0 .356.161.678.411.896zM15 10.427c0-1.08-.662-2.112-1.863-2.896-1.242-.806-2.903-1.257-4.669-1.257s-3.428.452-4.67 1.257c-1.202.783-1.863 1.815-1.863 2.896 0 1.089.661 2.121 1.863 2.904 1.242.806 2.903 1.258 4.669 1.258s3.428-.452 4.669-1.258C14.338 12.548 15 11.516 15 10.427zm-8.903.234c-.605 0-1.121-.492-1.121-1.097 0-.612.516-1.121 1.121-1.121s1.105.509 1.105 1.121c0 .605-.5 1.097-1.105 1.097zm4.984 1.606a.316.316 0 0 1 0 .443c-.54.54-1.379.798-2.573.798h-.016c-1.194 0-2.033-.258-2.573-.798a.316.316 0 0 1 0-.443.305.305 0 0 1 .436 0c.419.419 1.113.62 2.137.62h.016c1.017 0 1.718-.201 2.137-.62a.305.305 0 0 1 .436 0zm.943-2.703c0 .604-.5 1.097-1.105 1.097s-1.121-.492-1.121-1.097c0-.612.516-1.121 1.121-1.121s1.105.509 1.105 1.121zm1.016-6.273c0 .482.395.878.879.878s.879-.396.879-.878a.882.882 0 0 0-.879-.88.882.882 0 0 0-.879.88zm2.839 5.063c0-.661-.54-1.201-1.201-1.201-.258 0-.5.081-.694.226.694.557 1.185 1.21 1.436 1.92a1.21 1.21 0 0 0 .459-.945z"/></svg>
};
module.exports.Reload = function Reload (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M6 8H0V2h1v4.109C2.013 2.916 5.036.625 8.5.625c3.506 0 6.621 2.36 7.574 5.739l-.963.271A6.898 6.898 0 0 0 8.5 1.624C5.274 1.625 2.484 3.9 1.792 7H6v1zm5 1v1h4.208c-.693 3.101-3.479 5.375-6.708 5.375a6.895 6.895 0 0 1-6.611-5.011l-.963.271A7.9 7.9 0 0 0 8.5 16.374c3.459 0 6.475-2.28 7.5-5.482V15h1V9h-6z"/></svg>
};
module.exports.Rocket = function Rocket (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12 11V5c0-5-3-5-3-5S6 0 6 5v6s-2 0-2 6c0 0 2.379-2.375 4.312-2.895.004.582.31 1.051.688 1.051s.684-.47.688-1.051C11.621 14.625 14 17 14 17c0-6-2-6-2-6zM9 1.001c.26.021 1.667.27 1.947 2.999H7.053C7.333 1.271 8.74 1.022 9 1.001zM9 13c-1.271 0-2.742.868-3.877 1.717.263-2.121.859-2.629.993-2.717H7V5h4v7h.884c.134.088.73.596.993 2.717C11.742 13.868 10.271 13 9 13z"/></svg>
};
module.exports.RssAlt = function RssAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M11.173 17h-1C10.173 11.486 5.609 7 0 7V6c6.161 0 11.173 4.935 11.173 11zM0 0v1c8.972 0 16 7.028 16 16h1C17 7.468 9.532 0 0 0zm4 15.001A2 2 0 0 0 2.004 13 2.004 2.004 0 0 0 0 15.001a2 2 0 0 0 4 0zm-1 0a.999.999 0 0 1-.996.999A1.002 1.002 0 0 1 1 15.001a1 1 0 1 1 2 0z"/></svg>
};
module.exports.Rss = function Rss (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M9.969 14h-1c0-3.233-2.678-5.863-5.969-5.863v-1c3.843 0 6.969 3.079 6.969 6.863zM3 3.5v1c5.327 0 9.5 4.173 9.5 9.5h1C13.5 8.112 8.888 3.5 3 3.5zm3 9.001a1.5 1.5 0 1 0-3.002 0A1.5 1.5 0 0 0 6 12.5zm-1 0a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM17 15.5v-14c0-.827-.673-1.5-1.5-1.5h-14C.673 0 0 .673 0 1.5v14c0 .827.673 1.5 1.5 1.5h14c.827 0 1.5-.673 1.5-1.5zM15.5 1a.5.5 0 0 1 .5.5v14a.5.5 0 0 1-.5.5h-14a.5.5 0 0 1-.5-.5v-14a.5.5 0 0 1 .5-.5h14z"/></svg>
};
module.exports.RulerAlt2 = function RulerAlt2 (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 .293V17h16.707L0 .293zm1 2.414 2.957 2.957-.655.655.707.707.655-.655.709.709-.655.656.707.707.655-.655.71.709-.655.655.707.707.655-.655.71.71-.655.655.707.707.655-.655.709.709-.655.655.707.707.655-.655.71.71-.655.655.707.707.655-.655L14.293 16H1V2.707zM2 15h7.707L2 7.293V15zm1-5.293L7.293 14H3V9.707z"/></svg>
};
module.exports.RulerAlt = function RulerAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M12.036.015.015 12.036l4.95 4.949 12.02-12.02-4.949-4.95zM1.429 12.036l.696-.696 1.414 1.414.707-.707-1.414-1.414.719-.719.707.707.707-.707-.707-.707.707-.707 1.414 1.414.707-.707-1.414-1.414.696-.696.707.707.707-.707-.707-.707.707-.707 1.414 1.414.707-.707-1.414-1.414.718-.718.707.707.707-.707-.707-.707.707-.707 1.415 1.414.707-.707-1.415-1.414.708-.708 3.535 3.536L4.965 15.571l-3.536-3.535z"/></svg>
};
module.exports.RulerPencil = function RulerPencil (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M4.492 0H2.508c-.827 0-1.5.673-1.5 1.5v10.657l2.521 4.956 2.464-4.959V1.5A1.503 1.503 0 0 0 4.492 0zM2.508 1h1.984c.275 0 .5.225.5.5v1.019H2.008V1.5a.5.5 0 0 1 .5-.5zm-.5 3.55V3.519h2.984V4.55H2.008zm1.94 9.471h-.87l-1.07-2.104V5.55h1v6.481h1V5.55h.984v6.37l-1.044 2.101zM8 0v17h7V0H8zm6 16H9v-.984h2v-1H9V13h1v-1H9v-1h2v-1H9v-.984h1v-1H9v-1h2v-1H9V5h1V4H9V3h2V2H9V1h5v15z"/></svg>
};
module.exports.Ruler = function Ruler (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M5 0v17h7V0H5zm6 16H6v-.984h2v-1H6V13h1v-1H6v-1h2v-1H6v-.984h1v-1H6v-1h2v-1H6V5h1V4H6V3h2V2H6V1h5v15z"/></svg>
};
module.exports.SaveAlt = function SaveAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.5 0H2.836L0 2.776V15.5c0 .827.673 1.5 1.5 1.5h14c.827 0 1.5-.673 1.5-1.5v-14c0-.827-.673-1.5-1.5-1.5zM13 1v2H5V1h8zM3 16v-1h11v1H3zm13-.5a.5.5 0 0 1-.5.5H15v-2H2v2h-.5a.5.5 0 0 1-.5-.5V3.196L3.244 1H4v3h10V1h1.5a.5.5 0 0 1 .5.5v14zM8.5 5C6.57 5 5 6.57 5 8.5S6.57 12 8.5 12 12 10.43 12 8.5 10.43 5 8.5 5zm0 6C7.122 11 6 9.879 6 8.5S7.122 6 8.5 6 11 7.121 11 8.5 9.878 11 8.5 11z"/></svg>
};
module.exports.Save = function Save (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M14.164 0H1.5C.673 0 0 .673 0 1.5v14c0 .827.673 1.5 1.5 1.5h14c.827 0 1.5-.673 1.5-1.5V2.776L14.164 0zM8 1v4h3V1h1v5H4V1h4zM3 16v-6h11v6H3zm13-.5c0 .275-.225.5-.5.5H15V9H2v7h-.5a.5.5 0 0 1-.5-.5v-14a.5.5 0 0 1 .5-.5H3v6h10V1h.756L16 3.196V15.5z"/></svg>
};
...
module.exports.SharethisAlt = function SharethisAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.5 13.5c0 1.656-1.344 3-3 3h-10c-1.656 0-3-1.344-3-3v-10c0-1.656 1.344-3 3-3h10c1.656 0 3 1.344 3 3v10zm-4.886-4.114c-.583 0-1.114.229-1.51.604l-2.51-1.25c.01-.084.02-.156.02-.24s-.01-.156-.021-.24l2.51-1.249c.396.375.927.604 1.51.604a2.229 2.229 0 0 0 2.219-2.229c0-1.219-1-2.219-2.219-2.219a2.23 2.23 0 0 0-2.229 2.219c0 .083.01.156.021.239l-2.51 1.25a2.222 2.222 0 0 0-1.509-.594c-1.219 0-2.219.989-2.219 2.219a2.22 2.22 0 0 0 3.729 1.625l2.51 1.25c-.011.083-.021.156-.021.239 0 1.219 1 2.219 2.229 2.219 1.219 0 2.219-1 2.219-2.219 0-1.229-1-2.228-2.219-2.228z"/></svg>
};
module.exports.Sharethis = function Sharethis (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.5 13.168a3.33 3.33 0 0 1-3.333 3.332 3.329 3.329 0 0 1-3.313-3.686l-3.75-1.876A3.33 3.33 0 0 1 .5 8.5a3.329 3.329 0 0 1 3.333-3.332c.875 0 1.677.343 2.271.895l3.75-1.874A3.33 3.33 0 0 1 13.167.501 3.33 3.33 0 0 1 16.5 3.835a3.33 3.33 0 0 1-5.604 2.437l-3.75 1.875c.01.115.021.24.021.354 0 .115-.011.24-.021.354l3.75 1.877a3.335 3.335 0 0 1 2.271-.897 3.327 3.327 0 0 1 3.333 3.333z"/></svg>
};
module.exports.Shield = function Shield (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15 1.016c0 1.654-1.346 3-3 3s-3-1.346-3-3H8c0 1.654-1.346 3-3 3s-3-1.346-3-3H1v6.847c0 5.405 7.002 8 7.301 8.107l.166.061.167-.058C8.934 15.87 16 13.386 16 7.835V1.016h-1zM2 7.862V3.658a3.984 3.984 0 0 0 6-.011v11.114c-1.659-.747-6-3.067-6-6.899zm13-.027c0 3.895-4.293 6.163-6 6.912V3.646a3.984 3.984 0 0 0 6 .012v4.177z"/></svg>
};
module.exports.ShiftLeftAlt = function ShiftLeftAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M5.854 5.854 3.207 8.5l2.646 2.646-.707.707L1.793 8.5l3.354-3.354.707.708zM9 0v17h1V0H9z"/></svg>
};
module.exports.ShiftLeft = function ShiftLeft (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 9.001H5.708l3.646 3.646-.707.707L3.793 8.5l4.854-4.854.707.707-3.648 3.648H17v1zM0 17h1V0H0v17z"/></svg>
};
module.exports.ShiftRightAlt = function ShiftRightAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m15.207 8.5-3.354 3.354-.707-.707L13.793 8.5l-2.646-2.646.707-.707L15.207 8.5zM7 17h1V0H7v17z"/></svg>
};
module.exports.ShiftRight = function ShiftRight (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.354 3.646 13.207 8.5l-4.854 4.854-.707-.707L11.293 9H0V8h11.292L7.646 4.354l.708-.708zM16 0v17h1V0h-1z"/></svg>
};
module.exports.Shine = function Shine (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M8.5 5C6.57 5 5 6.57 5 8.5S6.57 12 8.5 12 12 10.43 12 8.5 10.43 5 8.5 5zm0 6C7.122 11 6 9.878 6 8.5S7.122 6 8.5 6 11 7.122 11 8.5 9.878 11 8.5 11zM9 4H8V1h1v3zm-1 9h1v3H8v-3zm8-5v1h-3V8h3zM4 9H1V8h3v1zm8.036-3.329-.707-.707 2.121-2.121.707.707-2.121 2.121zm-7.072 5.658.707.707-2.121 2.121-.707-.707 2.121-2.121zm7.072 0 2.121 2.121-.707.707-2.121-2.121.707-.707zM4.964 5.671 2.843 3.55l.707-.707 2.121 2.121-.707.707z"/></svg>
};
module.exports.ShoppingCartFull = function ShoppingCartFull (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M2.75 12.5c-.965 0-1.75.785-1.75 1.75S1.785 16 2.75 16s1.75-.785 1.75-1.75-.785-1.75-1.75-1.75zm0 2.5c-.413 0-.75-.337-.75-.75s.337-.75.75-.75.75.337.75.75-.337.75-.75.75zm8.5-2.5c-.965 0-1.75.785-1.75 1.75S10.285 16 11.25 16 13 15.215 13 14.25s-.785-1.75-1.75-1.75zm0 2.5c-.413 0-.75-.337-.75-.75s.337-.75.75-.75.75.337.75.75-.337.75-.75.75zm2.12-13-.301 2H-.074l1.117 8.036h11.914L14 4.536 14.231 3H17V2h-3.63zm-1.284 9.036H1.914L1.074 5h11.852l-.84 6.036zM11 10H3V6.031h1V9h6V6.03h1V10zM4 2.969H3V1h8v1.906h-1V2H4v.969z"/></svg>
};
...
module.exports.StatsDown = function StatsDown (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M5.166 8.803.795 4.847l.67-.741 3.773 3.413 4.204-3.026 5.593 6.25V8.458h1v4.036h-4.036v-1h2.366L9.296 5.829l-4.13 2.974zM0 16v1h17v-1H0z"/></svg>
};
module.exports.StatsUp = function StatsUp (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 16v1H0v-1h17zM5.203 7.976l4.204 3.026L15 4.751v2.284h1V3h-4.036v1h2.366L9.26 9.665 5.131 6.691.759 10.647l.671.741 3.773-3.412z"/></svg>
};
module.exports.Support = function Support (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M13.384 3c-.937-1.829-2.805-3-4.884-3S4.554 1.17 3.616 3H0v13h17V3h-3.616zM8.5 1c1.522 0 2.907.767 3.732 2H4.768A4.49 4.49 0 0 1 8.5 1zM16 15H1V4h15v11zm-8-5H6V9h2V7h1v2h2v1H9v2H8v-2z"/></svg>
};
...
module.exports.VideoClapper = function VideoClapper (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 1v15h17V1H0zm16 3h-.268l-2.356-2H16v2zM8.743 7 11.1 5h2.919l-2.357 2H8.743zm-1.94-3L4.446 2h2.918l2.357 2H6.803zm2.751 1L7.197 7H4.278l2.356-2h2.92zm1.714-1L8.911 2h2.918l2.357 2h-2.918zM1 2h1.9l2.357 2H1V2zm0 3h4.089L2.732 7H1V5zm15 10H1V8h15v7zm0-8h-2.792l2.356-2H16v2z"/></svg>
};
module.exports.ViewGrid = function ViewGrid (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 7h7V0H0v7zm1-6h5v5H1V1zm9-1v7h7V0h-7zm6 6h-5V1h5v5zM0 17h7v-7H0v7zm1-6h5v5H1v-5zm9 6h7v-7h-7v7zm1-6h5v5h-5v-5z"/></svg>
};
module.exports.ViewListAlt = function ViewListAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M5 0v4h12V0H5zm11 3H6V1h10v2zM5 10h12V6H5v4zm1-3h10v2H6V7zm-1 9h12v-4H5v4zm1-3h10v2H6v-2zM0 4h4V0H0v4zm1-3h2v2H1V1zm-1 9h4V6H0v4zm1-3h2v2H1V7zm-1 9h4v-4H0v4zm1-3h2v2H1v-2z"/></svg>
};
module.exports.ViewList = function ViewList (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M0 0v4h17V0H0zm16 3H1V1h15v2zM0 10h17V6H0v4zm1-3h15v2H1V7zm-1 9h17v-4H0v4zm1-3h15v2H1v-2z"/></svg>
};
module.exports.VimeoAlt = function VimeoAlt (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M16.132 2.301c-.58-.736-1.796-.764-2.645-.637-.68.113-2.998 1.131-3.777 3.579 1.387-.113 2.12.101 1.98 1.627-.058.65-.383 1.344-.736 2.024-.426.776-1.201 2.305-2.235 1.201-.919-.99-.863-2.885-1.06-4.144-.129-.708-.255-1.585-.482-2.32-.199-.623-.666-1.371-1.216-1.542-.608-.171-1.359.099-1.797.353C2.775 3.264 1.858 4.424.5 5.385v.1c.452.227.312.594.665.651.835.112 1.625-.78 2.179.154.339.565.438 1.188.649 1.798.296.819.511 1.711.75 2.645.396 1.6.878 3.975 2.263 4.557.695.297 1.756-.1 2.279-.426 1.441-.85 2.59-2.08 3.536-3.352 2.221-2.973 3.424-6.367 3.608-7.343.127-.666.113-1.345-.297-1.868z"/></svg>
};
module.exports.Vimeo = function Vimeo (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M15.664 2.69c-.416-.528-1.13-.808-2.063-.808-.264 0-.521.023-.758.059-.869.146-3.019 1.232-3.746 3.518a.499.499 0 0 0 .518.65c.562-.045.982-.012 1.112.133.104.113.142.386.106.768-.046.51-.333 1.099-.634 1.675-.145.264-.588 1.075-.862 1.075-.065 0-.169-.069-.276-.184-.514-.555-.62-1.613-.711-2.548-.032-.308-.061-.602-.104-.88l-.069-.391c-.095-.55-.203-1.173-.374-1.729-.206-.644-.699-1.474-1.421-1.698a1.858 1.858 0 0 0-.503-.066c-.688 0-1.306.329-1.481.431-.733.435-1.326.968-1.9 1.484-.433.388-.88.791-1.386 1.148-.132.094-.211.335-.211.497 0 .189.106.362.276.447.056.029.064.042.109.13.072.14.221.429.64.496.371.055.719-.054 1.008-.145.157-.05.306-.096.403-.096.035 0 .076 0 .159.139.173.289.268.619.368.969.052.178.103.356.166.54.222.611.392 1.278.571 1.984l.157.627c.358 1.475.849 3.493 2.219 4.068.207.088.443.133.703.133.669 0 1.377-.294 1.77-.54 1.166-.687 2.241-1.702 3.284-3.104 1.911-2.558 3.088-5.64 3.293-6.722.163-.866.045-1.54-.363-2.06zm-.619 1.874c-.146.768-1.153 3.688-3.112 6.309-.963 1.295-1.94 2.224-3.001 2.849-.394.246-1.187.501-1.564.341-.907-.381-1.329-2.116-1.637-3.384l-.161-.639c-.185-.729-.361-1.419-.596-2.07-.056-.16-.102-.322-.149-.482-.113-.395-.231-.804-.471-1.204-.246-.416-.588-.627-1.017-.627-.251 0-.48.072-.702.142-.159.05-.31.097-.479.107-.013-.023-.027-.05-.044-.078a20.8 20.8 0 0 0 1.054-.906c.562-.506 1.093-.983 1.738-1.365.232-.135.626-.293.975-.293.086 0 .164.01.22.025.256.079.593.547.75 1.038.151.49.253 1.08.342 1.601l.069.387c.039.247.065.523.095.812.107 1.092.23 2.328.975 3.131.312.333.651.502 1.008.502.868 0 1.393-.962 1.784-1.68.311-.597.646-1.291.708-1.98.064-.704-.051-1.19-.363-1.533-.314-.345-.761-.444-1.138-.471.808-1.539 2.363-2.115 2.671-2.167.184-.027.39-.046.602-.046.353 0 .986.056 1.277.426.218.279.272.689.166 1.255z"/></svg>
};
module.exports.Volume = function Volume (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M3.587 5.933c-.956 0-1.55.5-1.55 1.306V9.4a1.547 1.547 0 0 0 1.55 1.553H5.33l5.686 5.688V.212l-5.63 5.721H3.587zm6.429-3.279v11.572L5.744 9.953H3.586a.551.551 0 0 1-.549-.553V7.239c0-.091 0-.306.55-.306h2.217l4.212-4.279zm1.989 8.333v-1a1.009 1.009 0 0 0 0-2.016v-1c1.107 0 2.008.901 2.008 2.008s-.901 2.008-2.008 2.008zm4.024-2c0 2.206-1.794 4-4 4v-1c1.654 0 3-1.346 3-3s-1.346-3-3-3v-1c2.205 0 4 1.795 4 4z"/></svg>
};
module.exports.Wallet = function Wallet (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M1.564 2C.71 2 .014 2.69.014 3.538H0v10.939c0 .848.695 1.538 1.55 1.538h13.492V14.36H17V2H1.564zM1.55 15.014a.545.545 0 0 1-.55-.538V4.893c.024.007.054.005.078.012.143.042.293.068.453.071.007 0 .012.003.019.003h12.493v3.035h-2.859c-.862 0-1.563.673-1.563 1.5v1c0 .827.701 1.5 1.563 1.5h2.859v3H1.55zm9.633-4c-.311 0-.563-.224-.563-.5v-1c0-.276.253-.5.563-.5H16v2h-4.817zM16 13.359h-.958v-1.345H16v1.345zm-.958-5.345V3.979H1.564c-.273 0-.55-.137-.55-.441A.546.546 0 0 1 1.564 3H16v5.014h-.958z"/></svg>
};
module.exports.Wand = function Wand (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="M17 5h-3.293l2.328 2.328-.707.707L13 5.707V9h-1V5.714L1.354 16.379l-.707-.707L11.3 5H8V4h3.293L8.965 1.672l.707-.707L12 3.293V0h1v3.297l2.287-2.291.707.707L13.711 4H17v1z"/></svg>
};
module.exports.Wheelchair = function Wheelchair (props) {
  return <svg {...props} fill="currentColor" viewBox="0 0 17 17"><path d="m10.901 12.85.977.213A4.963 4.963 0 0 1 7 17c-2.757 0-5-2.243-5-5a5.002 5.002 0 0 1 3.725-4.836l.254.967A4.002 4.002 0 0 0 3 12c0 2.206 1.794 4 4 4a3.969 3.969 0 0 0 3.901-3.15zM16 15.121v1h-1.868l-.955-4.118H7.019l-.544-8.082A1.998 1.998 0 0 1 5 2c0-1.103.897-2 2-2s2 .897 2 2c0 .938-.65 1.72-1.521 1.936l.27 4.011 3.632-.901.24.971-3.805.943.138 2.042h6.018l.955 4.118H16zM7 3a1.001 1.001 0 1 0-1-1c0 .551.448 1 1 1z"/></svg>
};
