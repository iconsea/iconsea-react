...
module.exports.Es500PxWithCircle = function Es500PxWithCircle(props) {
...
module.exports.Basecamp = function Basecamp(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M10 2C5.327 2 .7 8.481.7 14.422.7 15.799 5.234 18 10 18s9.3-2.201 9.3-3.578C19.3 8.481 14.673 2 10 2zm.006 13.615c-5.198 0-6.673-2.068-6.673-2.722 0-1.287 2.13-4.485 2.906-4.485.719 0 1.542 1.811 2.314 1.811 1.241 0 2.567-3.954 3.579-3.954s4.601 5.178 4.601 6.749c0 .271-1.084 2.601-6.727 2.601z"
  }));
};
...
module.exports.CreativeCloud = function CreativeCloud(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.Dropbox = function Dropbox(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M6.109.902.4 4.457l3.911 3.279L10 4.043 6.109.902zm7.343 15.09a.44.44 0 0 1-.285-.102L10 13.262l-3.167 2.629a.447.447 0 0 1-.529.03l-2.346-1.533v.904L10 19.098l6.042-3.807v-.904l-2.346 1.533a.44.44 0 0 1-.244.072zM19.6 4.457 13.89.902 10 4.043l5.688 3.693L19.6 4.457zM10 11.291l3.528 2.928 5.641-3.688-3.481-2.795L10 11.291zm-3.528 2.928L10 11.291 4.311 7.736l-3.48 2.795 5.641 3.688z"
  }));
};
...
module.exports.Evernote = function Evernote(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M17.339 4.307c0-1.15-1.732-1.277-1.732-1.277l-4.069-.256s-.087-1.107-.909-1.492c-.822-.383-1.726-.266-2.376-.26-.65.007-.803.835-.803 1.617 0 .781.014 1.684.014 2.25 0 1.018-.447 1.449-1.566 1.449H3.591c-.645-.041-1.147.064-1.147.586 0 .523.759 4.973 1.801 6 .605.596 4.305 1.014 5.084 1.014.779 0 .519-2.301.736-2.301.217 0 .454 1.299 1.682 1.603 1.226.307 2.864.25 2.951 1.123.113 1.152.217 2.642-.541 2.748l-1.716.068c-1.176-.084-.86-1.369-.341-1.369s.779-.019.779-.019l.065-1.406s-2.693-.318-2.807 1.498c-.105 1.66.18 2.443.389 2.613.209.172.571.504 3.869.504 4.647 0 2.944-13.543 2.944-14.693zM15.44 10.32c-.182.196-.842-.32-1.472-.32-.631 0-1.311.334-1.471.113-.16-.219.146-1.99 1.334-1.99s1.793 2.004 1.609 2.197z"
  }), React.createElement("path", {
    fill: "currentColor",
    d: "M5.804 4.166c0-.229.058-2.984.058-2.984l-3.505 3.44h2.898c.476-.001.549-.229.549-.456z"
  }));
};

module.exports.FacebookWithCircle = function FacebookWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.FlickrWithCircle = function FlickrWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M10 .4C4.698.4.4 4.698.4 10s4.298 9.6 9.6 9.6 9.6-4.298 9.6-9.6S15.302.4 10 .4zM7.436 12a1.99 1.99 0 0 1-1.982-2c0-1.105.887-2 1.982-2 1.094 0 1.982.895 1.982 2s-.889 2-1.982 2zm5.129 0a1.991 1.991 0 0 1-1.983-2c0-1.105.888-2 1.983-2a1.99 1.99 0 0 1 1.982 2c0 1.105-.887 2-1.982 2z"
  }));
};
...
module.exports.Flickr = function Flickr(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M5 14c-2.188 0-3.96-1.789-3.96-4 0-2.211 1.772-4 3.96-4 2.187 0 3.96 1.789 3.96 4 0 2.211-1.773 4-3.96 4z"
  }), React.createElement("path", {
    fill: "currentColor",
    d: "M15 14c-2.188 0-3.96-1.789-3.96-4 0-2.211 1.772-4 3.96-4 2.187 0 3.96 1.789 3.96 4 0 2.211-1.773 4-3.96 4z"
  }));
};
...
module.exports.GoogleDrive = function GoogleDrive(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "m8.175 13-3.324 6h11.824L20 13H8.175zM5.865 2.299 0 12.914l3.372 6.084L9.238 8.383 5.865 2.299zM19.445 12 13.349 1H6.604l6.088 11h6.753z"
  }));
};
...
module.exports.InstagramWithCircle = function InstagramWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M13 10a3 3 0 1 1-6 0c0-.171.018-.338.049-.5H6v3.997c0 .278.225.503.503.503h6.995a.503.503 0 0 0 .502-.503V9.5h-1.049c.031.162.049.329.049.5zm-3 2a2 2 0 1 0-.001-4.001A2 2 0 0 0 10 12zm2.4-4.1h1.199a.301.301 0 0 0 .301-.3V6.401a.301.301 0 0 0-.301-.301H12.4a.301.301 0 0 0-.301.301V7.6c.001.165.136.3.301.3zM10 .4A9.6 9.6 0 0 0 .4 10a9.6 9.6 0 0 0 9.6 9.6 9.6 9.6 0 0 0 9.6-9.6A9.6 9.6 0 0 0 10 .4zm5 13.489C15 14.5 14.5 15 13.889 15H6.111C5.5 15 5 14.5 5 13.889V6.111C5 5.5 5.5 5 6.111 5h7.778C14.5 5 15 5.5 15 6.111v7.778z"
  }));
};
...
module.exports.Instagram = function Instagram(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M17 1H3c-1.1 0-2 .9-2 2v14c0 1.101.9 2 2 2h14c1.1 0 2-.899 2-2V3c0-1.1-.9-2-2-2zM9.984 15.523a5.539 5.539 0 0 0 5.538-5.539c0-.338-.043-.664-.103-.984H17v7.216a.69.69 0 0 1-.693.69H3.693a.69.69 0 0 1-.693-.69V9h1.549c-.061.32-.104.646-.104.984a5.54 5.54 0 0 0 5.539 5.539zM6.523 9.984a3.461 3.461 0 1 1 6.922 0 3.461 3.461 0 0 1-6.922 0zM16.307 6h-1.615A.694.694 0 0 1 14 5.308V3.691c0-.382.31-.691.691-.691h1.615c.384 0 .694.309.694.691v1.616c0 .381-.31.693-.693.693z"
  }));
};

module.exports.LastfmWithCircle = function LastfmWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.LinkedinWithCircle = function LinkedinWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.Linkedin = function Linkedin(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M5 3c0 1.062-.71 1.976-2.001 1.976C1.784 4.976 1 4.114 1 3.052 1 1.962 1.76 1 3 1s1.976.91 2 2zM1 19V6h4v13H1z"
  }), React.createElement("path", {
    fill: "currentColor",
    d: "M7 10.444c0-1.545-.051-2.836-.102-3.951h3.594l.178 1.723h.076c.506-.811 1.746-2 3.822-2C17.1 6.216 19 7.911 19 11.558V19h-4v-6.861c0-1.594-.607-2.81-2-2.81-1.062 0-1.594.86-1.873 1.569-.102.254-.127.608-.127.963V19H7v-8.556z"
  }));
};

module.exports.MediumWithCircle = function MediumWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.QqWithCircle = function QqWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
    ...
    fill: "currentColor",
    d: "M10 .4C4.698.4.4 4.698.4 10s4.298 9.6 9.6 9.6 9.6-4.298 9.6-9.6S15.302.4 10 .4zm4.008 11.92c-.184.096-.47-.122-.737-.52-.105.435-.369.828-.743 1.144.394.144.65.38.65.65 0 .442-.695.799-1.553.799-.773 0-1.415-.291-1.533-.672h-.184c-.12.38-.76.672-1.533.672-.857 0-1.552-.357-1.552-.8 0-.268.256-.505.65-.65-.375-.315-.638-.708-.745-1.143-.267.398-.553.616-.735.52-.265-.136-.213-.88.117-1.654.26-.61.612-1.06.879-1.158a1.18 1.18 0 0 1 .172-.748l-.002-.041c0-.11.026-.21.07-.298.068-1.586 1.1-2.845 2.771-2.845 1.67 0 2.703 1.259 2.771 2.845.044.088.07.188.07.298 0 .012 0 .027-.003.041a1.169 1.169 0 0 1 .173.748c.267.098.62.547.878 1.158.331.775.383 1.518.119 1.655z"
  }));
};
...
module.exports.RaftWithCircle = function RaftWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M10 .4C4.698.4.4 4.698.4 10s4.298 9.6 9.6 9.6 9.6-4.298 9.6-9.6S15.302.4 10 .4zm3.215 13.793a1.54 1.54 0 0 1-1.055.42c-.48 0-.867-.18-1.153-.532-.198-.244-.308-.496-.466-.936l-.078-.219c-.183-.498-.344-.75-.577-.879-.07.271-.149.525-.234.756-.445 1.216-1.077 1.832-1.88 1.832-.45 0-.848-.185-1.12-.522-.331-.413-.438-.996-.299-1.642l.03-.14 1.016.223-.03.138c-.072.332-.043.6.082.755a.393.393 0 0 0 .322.143c.4 0 .795-.639 1.094-1.76a2.932 2.932 0 0 1-.896-.49l-.11-.088.648-.818.11.089c.142.113.3.206.471.276.087-.498.156-1.046.207-1.63l.013-.142 1.035.091-.012.141a20.837 20.837 0 0 1-.212 1.683 2.28 2.28 0 0 0 1.727-1.087 2.277 2.277 0 0 0-.56-2.974c-.393-.31-.97-.486-1.507-.459-.672.028-1.238.33-1.682.91-.536.695-.592 1.738-.135 2.478l.075.12-.883.553-.075-.12c-.689-1.116-.609-2.627.196-3.672.631-.822 1.482-1.273 2.46-1.314.8-.031 1.603.217 2.192.68a3.315 3.315 0 0 1 .811 4.334 3.276 3.276 0 0 1-1.669 1.393c.13.198.24.434.367.78l.081.226c.256.714.373.778.641.778a.512.512 0 0 0 .338-.132c.161-.154.208-.45.141-.882l-.022-.14 1.027-.162.022.14c.122.78-.035 1.402-.451 1.801z"
  }));
};

module.exports.Raft = function Raft(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.Rainbow = function Rainbow(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M10 5C4.477 5 0 9.477 0 15h1.5a8.5 8.5 0 0 1 17 0H20c0-5.523-4.477-10-10-10zm0 6a4 4 0 0 0-4 4h1.5a2.5 2.5 0 1 1 5 0H14a4 4 0 0 0-4-4zm0-3a7 7 0 0 0-7 7h1.5a5.5 5.5 0 1 1 11 0H17a7 7 0 0 0-7-7z"
  }));
};

module.exports.RdioWithCircle = function RdioWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.Slideshare = function Slideshare(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M13 7.08a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zm5.845-1.137C15.265 8.498 13.616 8.051 12 8c-1.118-.057-1.5.298-1.5 1.08l.001 6c0 5 8.421 3.43 5.165-4.949 1.671-.959 3.076-2.434 3.876-3.412.411-.608-.028-1.245-.697-.776zM7 2.08a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM8 8c-1.616.051-3.265.498-6.845-2.057-.669-.469-1.108.168-.697.775.8.979 2.205 2.453 3.876 3.412-3.256 8.379 5.165 9.949 5.165 4.949l.001-6C9.5 8.298 9.118 7.943 8 8z"
  }));
};

module.exports.Smashing = function Smashing(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
    ...
    fill: "currentColor",
    d: "M10.023 16.032c-2.508 0-4.253-1.555-4.253-1.555L4.287 17.84c1.023.547 2.092.936 2.709 1.141l-1.592.381a1.391 1.391 0 0 1-1.675-1.029L.639 5.405a1.39 1.39 0 0 1 1.028-1.676l3.716-.889c-.91 1.029-1.263 2.252-1.174 3.65.139 2.193 2.237 3.879 4.734 4.822 4.701 1.776 3.586 4.72 1.08 4.72zm9.338-1.438L16.27 1.666A1.388 1.388 0 0 0 14.595.639l-2.663.637c.679.105 2.024.4 3.505 1.178l-1.159 3.213s-.965-1.078-3.553-1.209c-2.46-.125-3.828 2.537.969 4.105 3.674 1.201 4.848 3.516 4.787 5.658a5.123 5.123 0 0 1-.872 2.701l2.725-.652a1.39 1.39 0 0 0 1.027-1.676z"
  }));
};
...
module.exports.Soundcloud = function Soundcloud(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M.672 13.055 1 11.654l-.328-1.447c-.009-.043-.092-.076-.191-.076-.102 0-.184.033-.191.076L0 11.654l.289 1.4c.008.045.09.076.191.076.1.001.183-.03.192-.075zm2.051.777L3 11.668 2.723 8.32c-.009-.084-.114-.152-.239-.152-.127 0-.233.068-.238.152L2 11.668l.246 2.164c.006.086.111.152.238.152.125 0 .23-.066.239-.152zm2.045-.035L5 11.67l-.232-4.457c-.006-.106-.129-.188-.282-.188-.152 0-.275.082-.281.188L4 11.67l.205 2.129c.006.103.129.186.281.186.153-.001.276-.083.282-.188zm2.042-.031L7 11.67l-.19-4.49c-.005-.123-.146-.221-.32-.221-.176 0-.316.098-.321.221L6 11.67l.17 2.096c.004.123.145.221.32.221.174-.001.315-.096.32-.221zm2.04-.028L9 11.672l-.15-5.149c-.004-.142-.164-.255-.358-.255-.194 0-.354.115-.357.256L8 11.67l.135 2.068c.003.141.163.256.357.256.194 0 .354-.113.358-.256zm1.427.258 7.145.004C18.846 14 20 12.883 20 11.506c0-1.377-1.154-2.492-2.578-2.492-.353 0-.689.07-.996.193-.205-2.246-2.153-4.008-4.529-4.008a4.77 4.77 0 0 0-1.648.297c-.196.074-.247.148-.249.295v7.91a.306.306 0 0 0 .277.295z"
  }));
};

module.exports.SpotifyWithCircle = function SpotifyWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.StumbleuponWithCircle = function StumbleuponWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.Swarm = function Swarm(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M10.286 18.821a23.855 23.855 0 0 1-3.677-.923 58.46 58.46 0 0 1-1.007-.37.558.558 0 0 1-.317-.71c.086-.225.379-.949.399-.994.4-.92 1-2.153 1.795-3.379a9.16 9.16 0 0 0 2.807 6.376zm-.113-11.794C7.382 1.338 1.183 1.541.205 4.084c-.751 1.952 2.535 6.602 10.097 3.244l.004-.002a4.237 4.237 0 0 1-.133-.299zm1.387-.222.002-.001c4.271-1.897 3.674-5.191 2.569-5.614-1.487-.569-4.19 1.624-2.647 5.447.015.027.066.14.076.168zm7.853 4.165A5.567 5.567 0 0 0 16.2 7.986a1.243 1.243 0 0 0-.423-.073c-.717 0-1.407.595-1.472 1.338-.109 1.239.137 2.501.68 3.718.535 1.199 1.294 2.213 2.27 2.957.254.194.565.285.875.285.559 0 1.117-.296 1.339-.826a5.542 5.542 0 0 0-.056-4.415zm-3.241 6.369c-1.195-.912-2.142-2.139-2.815-3.646-.682-1.529-.961-3.075-.827-4.596.037-.423.161-.831.36-1.204l-.114.028a5.86 5.86 0 0 0-1.778.784c-.784.514-1.475 1.277-1.772 2.177-.08.243-.141.51-.161.765a7.54 7.54 0 0 0 .636 3.67 7.562 7.562 0 0 0 2.213 2.853c.566.447 1.586.73 2.42.73.783 0 1.556-.233 2.25-.585.217-.11.695-.408.726-.429a3.17 3.17 0 0 1-1.138-.547z"
  }));
};
...
module.exports.TumblrWithCircle = function TumblrWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.VimeoWithCircle = function VimeoWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
    ...
    fill: "currentColor",
    d: "M10 .4C4.698.4.4 4.698.4 10s4.298 9.6 9.6 9.6 9.6-4.298 9.6-9.6S15.302.4 10 .4zm4.401 7.75c-.508 2.916-3.348 5.387-4.201 5.951-.854.562-1.634-.227-1.916-.824-.324-.682-1.293-4.373-1.547-4.68-.254-.306-1.016.307-1.016.307l-.369-.494s1.547-1.883 2.724-2.117c1.248-.25 1.246 1.951 1.546 3.174.291 1.183.486 1.859.739 1.859.254 0 .739-.658 1.269-1.67.532-1.012-.022-1.906-1.061-1.27.415-2.54 4.34-3.152 3.832-.236z"
  }));
};
...
module.exports.VineWithCircle = function VineWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.XingWithCircle = function XingWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.Youko = function Youko(props) {
  return React.createElement("svg", _extends({}, props, {
    width: props.width || 48,
    fill: "currentColor",
    viewBox: "0 0 20 20"
...
module.exports.YoutubeWithCircle = function YoutubeWithCircle(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M11.603 9.833 9.357 8.785C9.161 8.694 9 8.796 9 9.013v1.974c0 .217.161.319.357.228l2.245-1.048c.197-.092.197-.242.001-.334zM10 .4C4.698.4.4 4.698.4 10s4.298 9.6 9.6 9.6 9.6-4.298 9.6-9.6S15.302.4 10 .4zm0 13.5c-4.914 0-5-.443-5-3.9s.086-3.9 5-3.9 5 .443 5 3.9-.086 3.9-5 3.9z"
  }));
};
...
module.exports.Youtube = function Youtube(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    fill: "currentColor",
    d: "M10 2.3C.172 2.3 0 3.174 0 10s.172 7.7 10 7.7 10-.874 10-7.7-.172-7.7-10-7.7zm3.205 8.034-4.49 2.096c-.393.182-.715-.022-.715-.456V8.026c0-.433.322-.638.715-.456l4.49 2.096c.393.184.393.484 0 .668z"
  }));
};